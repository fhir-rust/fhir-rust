...
- `fhir-mariadb init` for full R5 (7,355 tables + 9,168 indexes, of which 1,813
...
Gated benchmark: `FHIR_MARIADB_BENCH=100000 FHIR_MARIADB_TEST_DB=… cargo test
--release -p fhir-mariadb-store --test bench -- --nocapture`.
