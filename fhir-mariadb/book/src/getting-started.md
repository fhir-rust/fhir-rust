...
You need MariaDB 11.4 and Rust.

**There is no `fhir-mariadb` binary.** The commands this chapter used to show —
`fhir-mariadb init`, `load`, `serve` — do not exist in any port (`C0.17`,
