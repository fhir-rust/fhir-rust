...
//!
//! ```text
//! cargo run -p fhir-mariadb-gen --bin regen-assets            # rewrite assets/ and CHECKSUMS.txt
//! cargo run -p fhir-mariadb-gen --bin regen-assets -- --check # report drift, write nothing
//! ```
//!
