...
- **fhir-mssql-store** — **not written**; this port has no driver and no store. Transactional writes with
...
- **fhir-mssql-server** — axum. The FHIR RESTful API, bundle processing,
  generated CapabilityStatements, request ids, metrics.
- **fhir-mssql** — the CLI binary tying it together.
