...
- `fhir-sqlite init` for full R5 (7,355 tables + 9,168 indexes, of which 1,813
...
Gated benchmark: `FHIR_SQLITE_BENCH=100000 FHIR_SQLITE_TEST_DB=… cargo test
--release -p fhir-sqlite-store --test bench -- --nocapture`.
