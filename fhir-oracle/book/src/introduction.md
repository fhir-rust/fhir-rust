...
> a FHIR REST API over a store. `fhir-oracle` itself is a **library**: no binary,
...
fhir-oracle stores [FHIR](https://hl7.org/fhir/) resources in Oracle Database 12.2 or later as
...
The trade fhir-oracle makes is generation over convention: the schema (7,355
