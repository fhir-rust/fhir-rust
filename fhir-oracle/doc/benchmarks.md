...
- `fhir-oracle init` for full R5 (7,355 tables + 9,168 indexes, of which 1,813
...
Gated benchmark: `FHIR_ORACLE_BENCH=100000 FHIR_ORACLE_TEST_DB=… cargo test
--release -p fhir-oracle-store --test bench -- --nocapture`.
