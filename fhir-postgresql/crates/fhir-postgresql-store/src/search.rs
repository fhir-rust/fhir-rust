...
use fhir_postgresql_map::fold::{fold, prefix_upper};
use fhir_postgresql_map::model::{RelMap, ResourceMap, SearchDef, TargetKind};
...
fn target_pred(
    def: &SearchDef,
    t: &fhir_postgresql_map::model::SearchTarget,
    value: &str,
    modifier: Option<&str>,
    binds: &mut Vec<String>,
) -> Result<String, StoreError> {
