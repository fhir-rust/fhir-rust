...
//!
//! ```text
//! cargo run -p fhir-postgresql-gen --bin regen-assets            # rewrite assets/ and CHECKSUMS.txt
//! cargo run -p fhir-postgresql-gen --bin regen-assets -- --check # report drift, write nothing
//! ```
//!
...
use fhir_postgresql_gen::assets;
