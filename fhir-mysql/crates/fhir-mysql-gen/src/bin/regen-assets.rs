...
//!
//! ```text
//! cargo run -p fhir-mysql-gen --bin regen-assets            # rewrite assets/ and CHECKSUMS.txt
//! cargo run -p fhir-mysql-gen --bin regen-assets -- --check # report drift, write nothing
//! ```
//!
