...
| [F-58](#f-58) | Medium | `fhir-loco` is the service §10/§12 specify; five obligations remained unmet, incl. no stated requirement for the listener's own TLS | open, narrowing — spec question **closed** (`fhir-loco/spec/`); `SV2.14`, `SV4.3`, and `SV3.11` (posture stated **and enforced**: non-loopback plaintext bind refuses to boot) all closed 2026-08-07; two gaps remain: `SV2.15` Bulk Data and `SV4.2`, a Loco framework limit |
...
| **F-58** | `fhir-loco`'s remaining gaps (`SV2.15` Bulk Data; `SV4.2`, a Loco 1.0.1 framework limit — `SV2.14`, `SV4.3`, and `SV3.11` all closed 2026-08-07) are feature work in a crate with its own spec. |
