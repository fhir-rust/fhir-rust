...
| [F-58](#f-58) | Medium | `fhir-loco` is the service §10/§12 specify; five obligations remained unmet, incl. no stated requirement for the listener's own TLS | open, narrowing — spec question **closed** (`fhir-loco/spec/`); `SV2.14` conditional create **served 2026-08-07**; four gaps remain: `SV2.15`, `SV3.11`, `SV4.2`, `SV4.3` |
...
| **F-58** | `fhir-loco`'s remaining gaps (`SV2.15`, `SV3.11`, `SV4.2`, `SV4.3` — `SV2.14` was served 2026-08-07) are feature work in a crate with its own spec. |
