...
| [F-58](#f-58) | Medium | `fhir-loco` is the service §10/§12 specify; five obligations remained unmet, incl. no stated requirement for the listener's own TLS | open, narrowing — spec question **closed** (`fhir-loco/spec/`); `SV2.14` conditional create and `SV4.3` admin plane both **served 2026-08-07**; three gaps remain: `SV2.15`, `SV3.11`, `SV4.2` |
...
| **F-58** | `fhir-loco`'s remaining gaps (`SV2.15` Bulk Data, `SV3.11` a listener-TLS requirement to write, `SV4.2` a Loco framework limit — `SV2.14` and `SV4.3` were served 2026-08-07) are feature work in a crate with its own spec. |
