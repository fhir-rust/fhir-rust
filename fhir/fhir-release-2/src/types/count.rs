...
///
/// ```
/// use fhir::r2::types::count::CountQuantity;
/// use fhir::r2::types;
///
/// let value = CountQuantity {
...
///
/// let back: CountQuantity = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
