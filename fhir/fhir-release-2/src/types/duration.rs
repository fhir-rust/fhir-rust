...
///
/// ```
/// use fhir::r2::types::duration::Duration;
///
...
///
/// ```
/// use fhir::r2::types::duration::DurationQuantity;
/// use fhir::r2::types;
///
/// let value = DurationQuantity {
...
///
/// let back: DurationQuantity = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
