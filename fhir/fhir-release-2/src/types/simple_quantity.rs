...
///
/// ```
/// use fhir::r2::types::simple_quantity::SimpleQuantity;
///
...
///
/// ```
/// use fhir::r2::types::simple_quantity::SimpleQuantityQuantity;
/// use fhir::r2::types;
///
/// let value = SimpleQuantityQuantity {
...
///
/// let back: SimpleQuantityQuantity = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
...
#[serde(rename_all = "camelCase")]
#[fhir_version("r2")]
pub struct SimpleQuantityQuantity {
