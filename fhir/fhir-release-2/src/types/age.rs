...
/// time. If system is present, it SHALL be UCUM. If value is present, it SHALL
/// be positive.
///
/// # Examples
///
/// ```
/// use fhir::r2::types::age::AgeQuantity;
/// use fhir::r2::types;
///
/// let value = AgeQuantity {
...
///
/// let back: AgeQuantity = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
...
pub struct AgeQuantity {
    ...
    pub comparator: Option<crate::coded::Coded<crate::r2::codes::QuantityComparator>>,
