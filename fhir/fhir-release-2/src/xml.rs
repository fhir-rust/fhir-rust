//! FHIR R2 XML serialization (feature `xml`).
//!
...
//! by release and lives in [`::fhir_core::xml`]; this module binds it to the R2
//! [`meta`](crate::r2::meta) table.
//!
//! ```
//! use fhir::r2::resources::Patient;
//! use fhir::r2::xml::{to_xml, from_xml};
//!
...
mod tests {
    use super::*;
    use crate::r2::resources::{Observation, Patient};
