...
///
/// ```ignore
/// use fhir::r2::resources::composition::Composition;
///
...
pub struct Composition {
    ...
    pub status: crate::coded::Coded<crate::r2::codes::CompositionStatus>,
...
///
/// ```ignore
/// use fhir::r2::resources::composition::CompositionAttester;
///
...
pub struct CompositionAttester {
    ...
    pub mode: ::vec1::Vec1<crate::coded::Coded<crate::r2::codes::CompositionAttestationMode>>,
...
///
/// ```
/// use fhir::r2::resources::composition::CompositionEvent;
/// use fhir::r2::types;
///
...
///
/// ```
/// use fhir::r2::resources::composition::CompositionSection;
/// use fhir::r2::types;
///
...
pub struct CompositionSection {
    ...
    pub mode: Option<crate::coded::Coded<crate::r2::codes::ListMode>>,
    /// Primitive extension sibling for [`mode`](Self::mode) (FHIR `_mode`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_mode")]
