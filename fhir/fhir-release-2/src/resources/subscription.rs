...
///
/// ```
/// use fhir::r2::resources::subscription::Subscription;
/// use fhir::r2::types;
///
/// let value = Subscription {
///     error: Some(types::String("abc".to_string())),
///     ..Default::default()
/// };
/// let json = ::serde_json::to_value(&value).unwrap();
/// // `error` is the name this serializes to on the wire.
/// assert_eq!(json["error"], ::serde_json::json!("abc"));
///
...
pub struct Subscription {
    ...
    pub status: crate::coded::Coded<crate::r2::codes::SubscriptionStatus>,
...
///
/// ```
/// use fhir::r2::resources::subscription::SubscriptionChannel;
/// use fhir::r2::types;
///
...
pub struct SubscriptionChannel {
    ...
    pub r#type: crate::coded::Coded<crate::r2::codes::SubscriptionChannelType>,
