...
///
/// ```ignore
/// use fhir::r2::resources::immunization_recommendation::ImmunizationRecommendation;
///
...
///
/// ```
/// use fhir::r2::resources::immunization_recommendation::ImmunizationRecommendationRecommendation;
/// use fhir::r2::types;
///
...
///
/// ```
/// use fhir::r2::resources::immunization_recommendation::ImmunizationRecommendationRecommendationDateCriterion;
/// use fhir::r2::types;
///
...
///
/// ```
/// use fhir::r2::resources::immunization_recommendation::ImmunizationRecommendationRecommendationProtocol;
/// use fhir::r2::types;
///
/// let value = ImmunizationRecommendationRecommendationProtocol {
///     dose_sequence: Some(types::Integer(42)),
///     ..Default::default()
/// };
/// let json = ::serde_json::to_value(&value).unwrap();
/// // `doseSequence` is the name this serializes to on the wire.
/// assert_eq!(json["doseSequence"], ::serde_json::json!(42));
///
...
pub struct ImmunizationRecommendationRecommendationProtocol {
    ...
    pub dose_sequence: Option<types::Integer>,
