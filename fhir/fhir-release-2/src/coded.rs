...
//! this crate types them as the matching [`codes`](crate::r2::codes) enum. But
...
//! it is defined once in [`::fhir_core::coded`]; this module re-exports it so R2 code
//! can use `fhir::r2::coded::Coded`.
//!
//! ```
