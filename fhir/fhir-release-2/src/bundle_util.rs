//! Utilities for working with R2 `Bundle`s: iterating the contained resources,
//! following `next`-link paging, and building transaction/batch bundles.
//!
//! ```
//! use fhir::r2::resources::{Bundle, Patient};
//!
...
use crate::r2::coded::Coded;
use crate::r2::codes::{BundleType, HttpVerb};
use crate::r2::resources::Resource;
use crate::r2::resources::bundle::{Bundle, BundleEntry, BundleEntryRequest};
use crate::r2::types;
...
impl Bundle {
    ...
    ///
    /// R2 types `Bundle.link.relation` as a plain `string`; R5 later bound it
