...
struct TerminologyCapabilitiesDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r5::choice::Slot<TerminologyCapabilitiesVersionAlgorithm>,
    ...
    code_search: Option<crate::r5::coded::Coded<crate::r5::codes::CodeSearchSupport>>,
    #[serde(rename = "_codeSearch")]
