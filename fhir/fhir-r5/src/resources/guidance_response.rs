...
pub struct GuidanceResponse {
    ...
    pub performer: Option<types::Reference<crate::r5::resources::Device>>,
    ...
    pub evaluation_message: Option<types::Reference<crate::r5::resources::OperationOutcome>>,

    /// Reference to a Parameters resource containing the output parameters of the evaluation, if any
    pub output_parameters: Option<types::Reference<crate::r5::resources::Parameters>>,
...
struct GuidanceResponseDe {
    ...
    #[serde(flatten)]
    module: crate::r5::choice::Slot<GuidanceResponseModule>,
    status: crate::r5::coded::Coded<crate::r5::codes::GuidanceResponseStatus>,
    #[serde(rename = "_status")]
    ...
    performer: Option<types::Reference<crate::r5::resources::Device>>,
    #[serde(default)]
    reason: Vec<types::CodeableReference>,
    #[serde(default)]
    note: Vec<types::Annotation>,
    evaluation_message: Option<types::Reference<crate::r5::resources::OperationOutcome>>,
    output_parameters: Option<types::Reference<crate::r5::resources::Parameters>>,
    #[serde(default)]
    result: Vec<types::Reference>,
    #[serde(default)]
