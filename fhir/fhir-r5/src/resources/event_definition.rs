...
struct EventDefinitionDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r5::choice::Slot<EventDefinitionVersionAlgorithm>,
    ...
    #[serde(flatten)]
    subject: crate::r5::choice::Slot<EventDefinitionSubject>,
    ...
    trigger: vec1::Vec1<types::TriggerDefinition>,
}

impl ::core::convert::From<EventDefinitionDe> for EventDefinition {
    fn from(v: EventDefinitionDe) -> Self {
        Self {
            id: v.id,
            meta: v.meta,
