...
struct LibraryDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r5::choice::Slot<LibraryVersionAlgorithm>,
    ...
    #[serde(flatten)]
    subject: crate::r5::choice::Slot<LibrarySubject>,
    ...
    #[serde(default)]
    parameter: Vec<types::ParameterDefinition>,
    #[serde(default)]
    data_requirement: Vec<types::DataRequirement>,
    #[serde(default)]
    content: Vec<types::Attachment>,
}

impl ::core::convert::From<LibraryDe> for Library {
    fn from(v: LibraryDe) -> Self {
        Self {
            id: v.id,
            meta: v.meta,
