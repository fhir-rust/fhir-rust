...
pub struct StructureDefinition {
    ...
    pub fhir_version: Option<crate::r5::coded::Coded<crate::r5::codes::FhirVersion>>,
...
///
/// ```
/// use fhir::r5::resources::structure_definition::StructureDefinitionMapping;
/// use fhir::r5::types;
///
...
///
/// ```
/// use fhir::r5::resources::structure_definition::StructureDefinitionContext;
/// use fhir::r5::types;
///
...
///
/// ```ignore
/// use fhir::r5::resources::structure_definition::StructureDefinitionSnapshot;
///
...
///
/// ```ignore
/// use fhir::r5::resources::structure_definition::StructureDefinitionDifferential;
///
