...
///
/// ```
/// use fhir::r5::resources::genomic_study::GenomicStudyAnalysis;
/// use fhir::r5::types;
///
...
///
/// ```
/// use fhir::r5::resources::genomic_study::GenomicStudyAnalysisInput;
/// use fhir::r5::types;
///
...
struct GenomicStudyAnalysisInputDe {
    ...
    file: Option<types::Reference<crate::r5::resources::DocumentReference>>,
    r#type: Option<types::CodeableConcept>,
    #[serde(flatten)]
    generated_by: crate::r5::choice::Slot<GenomicStudyAnalysisInputGeneratedBy>,
}
...
///
/// ```
/// use fhir::r5::resources::genomic_study::GenomicStudyAnalysisOutput;
/// use fhir::r5::types;
///
...
///
/// ```
/// use fhir::r5::resources::genomic_study::GenomicStudyAnalysisPerformer;
/// use fhir::r5::types;
///
...
///
/// ```
/// use fhir::r5::resources::genomic_study::GenomicStudyAnalysisDevice;
/// use fhir::r5::types;
///
