...
struct ConceptMapDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r5::choice::Slot<ConceptMapVersionAlgorithm>,
    ...
    #[serde(default)]
    property: Vec<ConceptMapProperty>,
    #[serde(default)]
    additional_attribute: Vec<ConceptMapAdditionalAttribute>,
    #[serde(flatten)]
    source_scope: crate::r5::choice::Slot<ConceptMapSourceScope>,
    #[serde(flatten)]
    target_scope: crate::r5::choice::Slot<ConceptMapTargetScope>,
    #[serde(default)]
...
impl ::core::convert::From<ConceptMapDe> for ConceptMap {
    fn from(v: ConceptMapDe) -> Self {
        Self {
            ...
            property: v.property,
            additional_attribute: v.additional_attribute,
            source_scope: v.source_scope.0,
            target_scope: v.target_scope.0,
            group: v.group,
        }
    }
}
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, PartialEq, Eq, Validate)]
#[serde(rename_all = "camelCase")]
#[serde(from = "ConceptMapGroupElementTargetPropertyDe")]
...
#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
struct ConceptMapGroupElementTargetPropertyDe {
    id: Option<types::String>,
    #[serde(default)]
    extension: Vec<types::Extension>,
    #[serde(default)]
    ...
    #[serde(flatten)]
    value: crate::r5::choice::Slot<ConceptMapGroupElementTargetPropertyValue>,
}

impl ::core::convert::From<ConceptMapGroupElementTargetPropertyDe>
    for ConceptMapGroupElementTargetProperty
{
    fn from(v: ConceptMapGroupElementTargetPropertyDe) -> Self {
        Self {
            id: v.id,
            extension: v.extension,
            modifier_extension: v.modifier_extension,
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, PartialEq, Eq, Validate)]
#[serde(rename_all = "camelCase")]
#[serde(from = "ConceptMapGroupElementTargetDependsOnDe")]
...
#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
struct ConceptMapGroupElementTargetDependsOnDe {
    id: Option<types::String>,
    #[serde(default)]
    extension: Vec<types::Extension>,
    #[serde(default)]
    ...
    #[serde(rename = "_attribute")]
    attribute_ext: Option<types::Element>,
    #[serde(flatten)]
    value: crate::r5::choice::Slot<ConceptMapGroupElementTargetDependsOnValue>,
    value_set: Option<types::Canonical>,
    #[serde(rename = "_valueSet")]
    value_set_ext: Option<types::Element>,
}

impl ::core::convert::From<ConceptMapGroupElementTargetDependsOnDe>
    for ConceptMapGroupElementTargetDependsOn
{
    fn from(v: ConceptMapGroupElementTargetDependsOnDe) -> Self {
        Self {
            id: v.id,
            extension: v.extension,
            modifier_extension: v.modifier_extension,
            attribute: v.attribute,
            attribute_ext: v.attribute_ext,
            value: v.value.0,
