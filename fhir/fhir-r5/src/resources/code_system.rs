...
struct CodeSystemDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r5::choice::Slot<CodeSystemVersionAlgorithm>,
    ...
    content: crate::r5::coded::Coded<crate::r5::codes::CodesystemContentMode>,
    #[serde(rename = "_content")]
...
struct CodeSystemConceptPropertyDe {
    ...
    #[serde(flatten)]
    value: crate::r5::choice::Slot<CodeSystemConceptPropertyValue>,
}
