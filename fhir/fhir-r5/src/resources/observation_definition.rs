...
pub struct ObservationDefinition {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub specimen: Vec<types::Reference<crate::r5::resources::SpecimenDefinition>>,
...
struct ObservationDefinitionDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r5::choice::Slot<ObservationDefinitionVersionAlgorithm>,
    ...
    #[serde(default)]
    specimen: Vec<types::Reference<crate::r5::resources::SpecimenDefinition>>,
    #[serde(default)]
