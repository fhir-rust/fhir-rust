...
struct ValueSetDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r5::choice::Slot<ValueSetVersionAlgorithm>,
    ...
    immutable: Option<types::Boolean>,
    #[serde(rename = "_immutable")]
    immutable_ext: Option<types::Element>,
...
impl ::core::convert::From<ValueSetDe> for ValueSet {
    fn from(v: ValueSetDe) -> Self {
        Self {
            id: v.id,
            meta: v.meta,
...
struct ValueSetExpansionParameterDe {
    ...
    name_ext: Option<types::Element>,
    #[serde(flatten)]
    value: crate::r5::choice::Slot<ValueSetExpansionParameterValue>,
}
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, PartialEq, Eq, Validate)]
#[serde(rename_all = "camelCase")]
#[serde(from = "ValueSetExpansionContainsPropertyDe")]
...
#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
struct ValueSetExpansionContainsPropertyDe {
    id: Option<types::String>,
    #[serde(default)]
    extension: Vec<types::Extension>,
    #[serde(default)]
    ...
    #[serde(flatten)]
    value: crate::r5::choice::Slot<ValueSetExpansionContainsPropertyValue>,
    #[serde(default)]
    sub_property: Vec<ValueSetExpansionContainsPropertySubProperty>,
}

impl ::core::convert::From<ValueSetExpansionContainsPropertyDe>
    for ValueSetExpansionContainsProperty
{
    fn from(v: ValueSetExpansionContainsPropertyDe) -> Self {
        Self {
            id: v.id,
            extension: v.extension,
            modifier_extension: v.modifier_extension,
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, PartialEq, Eq, Validate)]
#[serde(rename_all = "camelCase")]
#[serde(from = "ValueSetExpansionContainsPropertySubPropertyDe")]
...
#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
struct ValueSetExpansionContainsPropertySubPropertyDe {
    id: Option<types::String>,
    #[serde(default)]
    extension: Vec<types::Extension>,
    #[serde(default)]
    ...
    code_ext: Option<types::Element>,
    #[serde(flatten)]
    value: crate::r5::choice::Slot<ValueSetExpansionContainsPropertySubPropertyValue>,
}

impl ::core::convert::From<ValueSetExpansionContainsPropertySubPropertyDe>
    for ValueSetExpansionContainsPropertySubProperty
{
    fn from(v: ValueSetExpansionContainsPropertySubPropertyDe) -> Self {
        Self {
            id: v.id,
            extension: v.extension,
            modifier_extension: v.modifier_extension,
