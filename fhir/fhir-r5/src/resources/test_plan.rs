...
struct TestPlanDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r5::choice::Slot<TestPlanVersionAlgorithm>,
...
struct TestPlanTestCaseTestRunScriptDe {
    ...
    #[serde(flatten)]
    source: crate::r5::choice::Slot<TestPlanTestCaseTestRunScriptSource>,
}
...
struct TestPlanTestCaseTestDataDe {
    ...
    #[serde(flatten)]
    source: crate::r5::choice::Slot<TestPlanTestCaseTestDataSource>,
}
