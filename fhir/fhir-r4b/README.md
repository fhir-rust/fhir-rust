...
The FHIR **Release 4 (4.3.0)** data model: every resource and datatype as typed
Rust, with validation, builders, and serde.

141 resources, 44 datatypes, 20 primitives, 531 code enums.
...
```toml
fhir = { version = "2", default-features = false, features = ["r4b"] }
```

The facade re-exports this crate as `fhir::r4b`, which is the path to
...
use fhir::r4b::resources::{Observation, Resource};
use fhir::r4b::types;
