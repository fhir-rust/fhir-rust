//! FHIR R4B datatypes.
//!
//! This module contains every FHIR R4B datatype: the **complex** datatypes
...
//! `fhir::r4b::types::Period` rather than `fhir::r4b::types::period::Period`.
...
pub use prod_characteristic::ProdCharacteristic;
