//! FHIR R4B code systems as type-safe Rust enums.
//!
//! Each enum corresponds to a complete FHIR R4B `CodeSystem`. Variants
//! serialize to and from their canonical FHIR code strings via serde renames.
//!
//! # Examples
//!
//! ```
//! use fhir::r4b::codes::AdministrativeGender;
//!
...
/// This codesystem defines a set of codes that can be used to indicate from
...
pub enum ArticleUrlType {
    ...
    FullText,
    /// Full-Text Version
    #[serde(rename = "full-text-version")]
    FullTextVersion,
    /// PDF
    #[serde(rename = "pdf")]
    Pdf,
    /// PDF Version
    #[serde(rename = "pdf-version")]
    PdfVersion,
    /// Webpage
    ...
    Json,
    /// JSON Version
    #[serde(rename = "json-version")]
    JsonVersion,
    /// XML
    #[serde(rename = "xml")]
    Xml,
    /// XML
    #[serde(rename = "xml-version")]
    XmlVersion,
    /// Supplement
    #[serde(rename = "supplement")]
    Supplement,
    /// Supplementary file directory
    #[serde(rename = "supplementary-file-directory")]
...
pub enum AttributeEstimateType {
    ...
    #[default]
    #[serde(rename = "0000419")]
    N0000419,
    /// Confidence interval
    #[serde(rename = "C53324")]
    C53324,
    /// Credible interval
    #[serde(rename = "0000455")]
    N0000455,
    /// I-squared
    #[serde(rename = "0000420")]
    N0000420,
    /// Interquartile range
    #[serde(rename = "C53245")]
    C53245,
    ...
    #[serde(rename = "0000037")]
    N0000037,
    /// Tau squared
    #[serde(rename = "0000421")]
    N0000421,
    /// Variance
    #[serde(rename = "C48918")]
    C48918,
...
/// The `http://hl7.org/fhir/catalogType` code system.
///
...
/// The `http://hl7.org/fhir/clinical-use-definition-category` code system.
///
...
///
/// System: <http://hl7.org/fhir/contract-action>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/contract-actorrole>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/contract-signer-type>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/contract-subtype>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/contract-term-subtype>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/contract-term-type>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/contract-type>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
/// This codesystem defines a set of codes that can be used to indicate dietary
...
/// This codesystem defines a set of codes that can be used to where the
...
/// This codesystem defines a set of codes that can be used to indicate the
/// kinds of special arrangements in place for a patient's visit.
///
...
/// This example codesystem defines a set of codes that can be used to indicate
...
/// This is an example codesystem defined by the FHIR project, that could be
...
/// This is an example codesystem defined by the FHIR project, it represents
/// global concepts for no content, or any unrestricted content.
///
...
/// This incomplete example codesystem defines a set of codes that can be used
/// to express the usage type of an EpisodeOfCare record.
///
...
/// Materials used or needed to feed the patient. These values are provided as
...
/// This example code System defines a set of codes that can be used to
...
/// This code system supports describing the validity of a dose relative to a
/// particular recommended schedule.
///
...
/// This code system supports describing the reason why an administered dose
/// has been assigned a particular status. Often, this reason describes why a
...
/// This code system supports describing the source of the vaccine actually
/// administered. This may be different than the patient eligbility (e.g. the
/// patient may be eligibile for a publically purchased vaccine but due to
...
/// This code system supports describing the source of the data when the report
/// of the immunization event is not based on information from the person,
/// entity or organization who administered the vaccine.
///
...
/// This code system supports describing the source of the patient's
/// eligibility for a vaccination program.
///
...
/// to support describing the status of the patient relative to a recommended
/// dose. This value set is provided as a suggestive example.
///
...
/// This code system supports describing the reason why a dose is considered to
/// be subpotent.
///
...
///
/// System: <http://hl7.org/fhir/insuranceplan-applicability>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
/// This code system defines a defines the set of codes for describing the type
/// or mode of the patient's preferred language.
///
...
/// The `http://terminology.hl7.org/CodeSystem/med-admin-perform-function` code
/// system.
///
...
/// Codes for high level media types - whether the media is an image, video, or
/// audio.
///
...
/// The `http://terminology.hl7.org/CodeSystem/medication-admin-category` code
/// system.
///
...
/// The `http://terminology.hl7.org/CodeSystem/medication-admin-status` code
/// system.
///
...
/// The `http://terminology.hl7.org/CodeSystem/medication-statement-category`
/// code system.
///
...
/// The `http://hl7.org/fhir/CodeSystem/medication-statement-status` code
/// system.
///
...
/// The `http://hl7.org/fhir/CodeSystem/medication-status` code system.
///
...
/// The `http://terminology.hl7.org/CodeSystem/medicationdispense-category`
/// code system.
///
...
/// The `http://terminology.hl7.org/CodeSystem/medicationdispense-status` code
/// system.
///
...
/// The `http://terminology.hl7.org/CodeSystem/medicationknowledge-status` code
/// system.
///
...
/// The `http://terminology.hl7.org/CodeSystem/medicationrequest-category` code
/// system.
///
...
/// The `http://hl7.org/fhir/CodeSystem/medicationrequest-intent` code system.
///
...
/// The `http://hl7.org/fhir/CodeSystem/medicationrequest-status` code system.
///
...
/// The `http://terminology.hl7.org/CodeSystem/medicationrequest-status-reason`
/// code system.
///
...
/// conduct post-authorisation studies.
///
...
pub enum MedicinalProductSpecialMeasures {
    ...
    #[default]
    #[serde(rename = "Post-authorisationStudies")]
...
/// The `http://hl7.org/fhir/observation-statistics` code system.
///
...
pub enum PackageCharacteristic {
    /// Hospital pack
    #[default]
    #[serde(rename = "HospitalPack")]
    HospitalPack,
    /// Nurse prescribable
    #[serde(rename = "NursePrescribable")]
    NursePrescribable,
    /// Calendar pack
    #[serde(rename = "CalendarPack")]
    CalendarPack,
}
...
/// This codesystem defines a set of codes that can be used to indicate how an
...
/// The `http://hl7.org/fhir/product-intended-use` code system.
///
...
/// The `http://hl7.org/fhir/regulated-authorization-basis` code system.
///
...
/// The `http://hl7.org/fhir/regulated-authorization-case-type` code system.
///
...
/// The `http://hl7.org/fhir/regulated-authorization-type` code system.
///
...
/// The `http://hl7.org/fhir/resource-validation-mode` code system.
///
...
pub enum StatisticType {
    ...
    #[serde(rename = "0000565")]
    N0000565,
    /// Relative Risk
    #[serde(rename = "C93152")]
    C93152,
    /// Risk Difference
    #[serde(rename = "0000424")]
    N0000424,
    /// Spearman Rank-Order Correlation
    #[serde(rename = "C65171")]
    C65171,
    /// Standardized Mean Difference
    #[serde(rename = "0000100")]
    N0000100,
}
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum SubscriptionSearchModifier {
    /// \=
    #[default]
    #[serde(rename = "=")]
    Unnamed,
...
/// The `http://hl7.org/fhir/substance-grade` code system.
///
...
/// The `http://hl7.org/fhir/substance-name-authority` code system.
///
...
/// The `http://hl7.org/fhir/substance-name-domain` code system.
///
...
/// The `http://hl7.org/fhir/substance-name-type` code system.
///
...
/// The `http://hl7.org/fhir/substance-representation-format` code system.
///
...
/// The `http://hl7.org/fhir/substance-representation-type` code system.
///
...
/// The `http://hl7.org/fhir/substance-source-material-genus` code system.
///
...
/// The `http://hl7.org/fhir/substance-source-material-part` code system.
///
...
/// The `http://hl7.org/fhir/substance-source-material-species` code system.
///
...
/// The `http://hl7.org/fhir/substance-source-material-type` code system.
///
...
/// The `http://hl7.org/fhir/substance-structure-technique` code system.
///
...
/// The `http://hl7.org/fhir/substance-weight-method` code system.
///
...
/// The `http://hl7.org/fhir/substance-weight-type` code system.
///
...
pub enum VariableRole {
    ...
    Population,
    /// subpopulation
    #[serde(rename = "subpopulation")]
    Subpopulation,
    /// exposure
    #[serde(rename = "exposure")]
    Exposure,
    /// reference exposure
    #[serde(rename = "referenceExposure")]
    ReferenceExposure,
    /// measured variable
    #[serde(rename = "measuredVariable")]
    MeasuredVariable,
    /// confounder
...
///
/// System: <http://hl7.org/fhir/verificationresult-can-push-updates>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
/// This code system defines the methods by which entities participating in a
/// validation process share information (e.g. submission/retrieval of attested
/// information, or exchange of validated information).
///
/// System: <http://hl7.org/fhir/verificationresult-communication-method>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/verificationresult-failure-action>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/verificationresult-need>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/verificationresult-primary-source-type>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/verificationresult-push-type-available>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/verificationresult-validation-process>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/verificationresult-validation-status>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/verificationresult-validation-type>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
