//! Utilities for working with R4B `Bundle`s: iterating the contained resources,
//! following `next`-link paging, and building transaction/batch bundles.
//!
//! ```
//! use fhir::r4b::resources::{Bundle, Patient};
//!
...
use crate::r4b::codes::{BundleType, HttpVerb};
use crate::r4b::resources::Resource;
use crate::r4b::resources::bundle::{Bundle, BundleEntry, BundleEntryRequest};
use crate::r4b::types;
...
impl Bundle {
    ...
    ///
    /// R4B types `Bundle.link.relation` as a plain `string`; R5 later bound it
