...
///
/// ```
/// use fhir::r4b::types::timing::Timing;
/// use fhir::r4b::types;
///
/// let value = Timing {
...
///
/// ```
/// use fhir::r4b::types::timing::TimingRepeat;
/// use fhir::r4b::types;
///
...
pub struct TimingRepeat {
    ...
    #[serde(default, skip_serializing_if = "::fhir_core::PrimVec::is_empty")]
    pub day_of_week: ::fhir_core::PrimVec<crate::coded::Coded<crate::r4b::codes::DaysOfWeek>>,
    ...
    #[serde(default, skip_serializing_if = "::fhir_core::PrimVec::is_empty")]
    pub when: ::fhir_core::PrimVec<crate::coded::Coded<crate::r4b::codes::EventTiming>>,
...
struct TimingRepeatDe {
    ...
    #[serde(flatten)]
    bounds: crate::r4b::choice::Slot<TimingRepeatBounds>,
    ...
    #[serde(default)]
    day_of_week: ::fhir_core::PrimVec<crate::coded::Coded<crate::r4b::codes::DaysOfWeek>>,
    #[serde(rename = "_dayOfWeek")]
    #[serde(default)]
    ...
    #[serde(default)]
    when: ::fhir_core::PrimVec<crate::coded::Coded<crate::r4b::codes::EventTiming>>,
    #[serde(rename = "_when")]
    #[serde(default)]
