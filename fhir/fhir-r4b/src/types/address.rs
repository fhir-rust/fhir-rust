...
///
/// ```
/// use fhir::r4b::types::address::Address;
/// use fhir::r4b::types;
///
/// let value = Address {
...
pub struct Address {
    ...
    pub r#use: Option<crate::coded::Coded<crate::r4b::codes::AddressUse>>,
    ...
    pub r#type: Option<crate::coded::Coded<crate::r4b::codes::AddressType>>,
