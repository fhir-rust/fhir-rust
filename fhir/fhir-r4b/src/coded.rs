...
//! this crate types them as the matching [`codes`](crate::r4b::codes) enum. But
...
//! it is defined once in [`::fhir_core::coded`]; this module re-exports it so R4B code
//! can use `fhir::r4b::coded::Coded`.
//!
//! ```
