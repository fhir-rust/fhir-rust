//! Support types for FHIR R4B `value[x]` choice elements.
//!
...
mod tests {
    use super::*;
    use crate::r4b::types::{Boolean, Quantity, String as FhirString};
    ...
    fn validate_runs_on_active_variant() {
        ...
        let invalid = TestValue::Quantity(Box::new(Quantity {
            code: Some(crate::r4b::types::Code(String::new())),
            ..Default::default()
        }));
