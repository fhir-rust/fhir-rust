//! Parsing and precision-aware comparison for the FHIR R4B date/time
//! primitives.
//!
...
//! R4B newtypes and re-exports the shared types.
//!
//! ```
//! use fhir::r4b::types::Date;
//! use fhir::r4b::temporal::DatePrecision;
//!
...
use crate::r4b::types::{Date, DateTime, Instant, Time};
