...
///
/// ```
/// use fhir::r4b::resources::group::Group;
/// use fhir::r4b::types;
///
/// let value = Group {
...
pub struct Group {
    ...
    pub r#type: crate::coded::Coded<crate::r4b::codes::GroupType>,
...
///
/// ```
/// use fhir::r4b::resources::group::GroupCharacteristic;
/// use fhir::r4b::types;
///
...
struct GroupCharacteristicDe {
    ...
    #[serde(flatten)]
    value: crate::r4b::choice::Slot<GroupCharacteristicValue>,
...
///
/// ```
/// use fhir::r4b::resources::group::GroupMember;
/// use fhir::r4b::types;
///
