...
///
/// ```
/// use fhir::r4b::resources::adverse_event::AdverseEvent;
/// use fhir::r4b::types;
///
...
pub struct AdverseEvent {
    ...
    /// actual | potential
    pub actuality: crate::coded::Coded<crate::r4b::codes::AdverseEventActuality>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub resulting_condition: Vec<types::Reference<crate::r4b::resources::Condition>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub reference_document: Vec<types::Reference<crate::r4b::resources::DocumentReference>>,

    /// AdverseEvent.study
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub study: Vec<types::Reference<crate::r4b::resources::ResearchStudy>>,
}
...
///
/// ```
/// use fhir::r4b::resources::adverse_event::AdverseEventSuspectEntity;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::adverse_event::AdverseEventSuspectEntityCausality;
/// use fhir::r4b::types;
///
