...
///
/// ```
/// use fhir::r4b::resources::imaging_study::ImagingStudy;
/// use fhir::r4b::types;
///
...
pub struct ImagingStudy {
    ...
    pub status: crate::coded::Coded<crate::r4b::codes::ImagingstudyStatus>,
    ...
    pub procedure_reference: Option<types::Reference<crate::r4b::resources::Procedure>>,
...
///
/// ```
/// use fhir::r4b::resources::imaging_study::ImagingStudySeries;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::imaging_study::ImagingStudySeriesInstance;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::imaging_study::ImagingStudySeriesPerformer;
/// use fhir::r4b::types;
///
