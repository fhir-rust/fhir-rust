...
///
/// ```
/// use fhir::r4b::resources::episode_of_care::EpisodeOfCare;
/// use fhir::r4b::types;
///
...
pub struct EpisodeOfCare {
    ...
    /// entered-in-error
    pub status: crate::coded::Coded<crate::r4b::codes::EpisodeOfCareStatus>,
    ...
    pub managing_organization: Option<types::Reference<crate::r4b::resources::Organization>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub referral_request: Vec<types::Reference<crate::r4b::resources::ServiceRequest>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub team: Vec<types::Reference<crate::r4b::resources::CareTeam>>,
...
///
/// ```
/// use fhir::r4b::resources::episode_of_care::EpisodeOfCareDiagnosis;
/// use fhir::r4b::types;
///
...
pub struct EpisodeOfCareDiagnosis {
    ...
    pub condition: types::Reference<crate::r4b::resources::Condition>,
...
///
/// ```
/// use fhir::r4b::resources::episode_of_care::EpisodeOfCareStatusHistory;
/// use fhir::r4b::types;
///
