...
///
/// ```
/// use fhir::r4b::resources::charge_item::ChargeItem;
/// use fhir::r4b::types;
///
...
pub struct ChargeItem {
    ...
    /// | unknown
    pub status: crate::coded::Coded<crate::r4b::codes::ChargeitemStatus>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub part_of: Vec<types::Reference<crate::r4b::resources::ChargeItem>>,
    ...
    pub performing_organization: Option<types::Reference<crate::r4b::resources::Organization>>,

    /// Organization requesting the charged service
    pub requesting_organization: Option<types::Reference<crate::r4b::resources::Organization>>,

    /// Organization that has ownership of the (potential, future) revenue
    pub cost_center: Option<types::Reference<crate::r4b::resources::Organization>>,
...
///
/// ```
/// use fhir::r4b::resources::charge_item::ChargeItemPerformer;
/// use fhir::r4b::types;
///
