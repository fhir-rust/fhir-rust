...
struct MedicationStatementDe {
    ...
    status: crate::coded::Coded<crate::r4b::codes::MedicationStatementStatus>,
    #[serde(rename = "_status")]
    ...
    #[serde(flatten)]
    medication: crate::r4b::choice::Slot<MedicationStatementMedication>,
    subject: types::Reference,
    context: Option<types::Reference>,
    #[serde(flatten)]
    effective: crate::r4b::choice::Slot<MedicationStatementEffective>,
