...
///
/// ```
/// use fhir::r4b::resources::communication_request::CommunicationRequest;
/// use fhir::r4b::types;
///
...
pub struct CommunicationRequest {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub replaces: Vec<types::Reference<crate::r4b::resources::CommunicationRequest>>,
...
struct CommunicationRequestDe {
    ...
    #[serde(default)]
    replaces: Vec<types::Reference<crate::r4b::resources::CommunicationRequest>>,
    ...
    #[serde(flatten)]
    occurrence: crate::r4b::choice::Slot<CommunicationRequestOccurrence>,
...
///
/// ```
/// use fhir::r4b::resources::communication_request::CommunicationRequestPayload;
/// use fhir::r4b::types;
///
...
struct CommunicationRequestPayloadDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    content: crate::r4b::choice::Slot<CommunicationRequestPayloadContent>,
}
