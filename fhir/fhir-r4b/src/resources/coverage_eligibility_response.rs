...
///
/// ```ignore
/// use fhir::r4b::resources::coverage_eligibility_response::CoverageEligibilityResponse;
///
...
pub struct CoverageEligibilityResponse {
    ...
    pub purpose: ::vec1::Vec1<crate::coded::Coded<crate::r4b::codes::EligibilityresponsePurpose>>,
    ...
    pub request: types::Reference<crate::r4b::resources::CoverageEligibilityRequest>,
...
struct CoverageEligibilityResponseDe {
    ...
    status: crate::coded::Coded<crate::r4b::codes::FmStatus>,
    #[serde(rename = "_status")]
    status_ext: Option<types::Element>,
    purpose: ::vec1::Vec1<crate::coded::Coded<crate::r4b::codes::EligibilityresponsePurpose>>,
    #[serde(rename = "_purpose")]
    #[serde(default)]
    purpose_ext: Vec<Option<types::Element>>,
    patient: types::Reference<crate::r4b::resources::Patient>,
    #[serde(flatten)]
    serviced: crate::r4b::choice::Slot<CoverageEligibilityResponseServiced>,
    created: types::DateTime,
    #[serde(rename = "_created")]
    created_ext: Option<types::Element>,
    requestor: Option<types::Reference>,
    request: types::Reference<crate::r4b::resources::CoverageEligibilityRequest>,
    outcome: crate::coded::Coded<crate::r4b::codes::RemittanceOutcome>,
    #[serde(rename = "_outcome")]
    outcome_ext: Option<types::Element>,
    disposition: Option<types::String>,
    #[serde(rename = "_disposition")]
    disposition_ext: Option<types::Element>,
    insurer: types::Reference<crate::r4b::resources::Organization>,
    #[serde(default)]
...
///
/// ```
/// use fhir::r4b::resources::coverage_eligibility_response::CoverageEligibilityResponseError;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::coverage_eligibility_response::CoverageEligibilityResponseInsurance;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::coverage_eligibility_response::CoverageEligibilityResponseInsuranceItem;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::coverage_eligibility_response::CoverageEligibilityResponseInsuranceItemBenefit;
/// use fhir::r4b::types;
///
...
struct CoverageEligibilityResponseInsuranceItemBenefitDe {
    ...
    #[serde(flatten)]
    allowed: crate::r4b::choice::Slot<CoverageEligibilityResponseInsuranceItemBenefitAllowed>,
    #[serde(flatten)]
    used: crate::r4b::choice::Slot<CoverageEligibilityResponseInsuranceItemBenefitUsed>,
}
