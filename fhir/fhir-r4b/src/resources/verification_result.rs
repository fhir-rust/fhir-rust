...
///
/// ```
/// use fhir::r4b::resources::verification_result::VerificationResult;
/// use fhir::r4b::types;
///
...
pub struct VerificationResult {
    ...
    pub status: crate::coded::Coded<crate::r4b::codes::VerificationresultStatus>,
...
///
/// ```
/// use fhir::r4b::resources::verification_result::VerificationResultAttestation;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::verification_result::VerificationResultPrimarySource;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::verification_result::VerificationResultValidator;
/// use fhir::r4b::types;
///
...
pub struct VerificationResultValidator {
    ...
    pub organization: types::Reference<crate::r4b::resources::Organization>,
