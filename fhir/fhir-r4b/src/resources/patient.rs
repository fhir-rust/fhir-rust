...
///
/// ```
/// use fhir::r4b::resources::patient::Patient;
/// use fhir::r4b::types;
///
/// let value = Patient {
...
struct PatientDe {
    ...
    gender: Option<crate::coded::Coded<crate::r4b::codes::AdministrativeGender>>,
    #[serde(rename = "_gender")]
    ...
    #[serde(flatten)]
    deceased: crate::r4b::choice::Slot<PatientDeceased>,
    #[serde(default)]
    address: Vec<types::Address>,
    marital_status: Option<types::CodeableConcept>,
    #[serde(flatten)]
    multiple_birth: crate::r4b::choice::Slot<PatientMultipleBirth>,
    #[serde(default)]
    ...
    managing_organization: Option<types::Reference<crate::r4b::resources::Organization>>,
    #[serde(default)]
...
///
/// ```
/// use fhir::r4b::resources::patient::PatientCommunication;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::patient::PatientContact;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::patient::PatientLink;
/// use fhir::r4b::types;
///
...
pub struct PatientLink {
    ...
    pub r#type: crate::coded::Coded<crate::r4b::codes::LinkType>,
