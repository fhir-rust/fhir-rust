...
///
/// ```ignore
/// use fhir::r4b::resources::composition::Composition;
///
...
pub struct Composition {
    ...
    pub status: crate::coded::Coded<crate::r4b::codes::CompositionStatus>,
...
///
/// ```
/// use fhir::r4b::resources::composition::CompositionAttester;
/// use fhir::r4b::types;
///
...
pub struct CompositionAttester {
    ...
    pub mode: crate::coded::Coded<crate::r4b::codes::CompositionAttestationMode>,
...
///
/// ```
/// use fhir::r4b::resources::composition::CompositionEvent;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::composition::CompositionRelatesTo;
/// use fhir::r4b::types;
///
...
struct CompositionRelatesToDe {
    ...
    code: crate::coded::Coded<crate::r4b::codes::DocumentRelationshipType>,
    #[serde(rename = "_code")]
    code_ext: Option<types::Element>,
    #[serde(flatten)]
    target: crate::r4b::choice::Slot<CompositionRelatesToTarget>,
}
...
///
/// ```
/// use fhir::r4b::resources::composition::CompositionSection;
/// use fhir::r4b::types;
///
