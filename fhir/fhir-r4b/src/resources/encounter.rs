...
///
/// ```
/// use fhir::r4b::resources::encounter::Encounter;
/// use fhir::r4b::types;
///
/// let value = Encounter {
...
pub struct Encounter {
    ...
    /// cancelled +
    pub status: crate::coded::Coded<crate::r4b::codes::EncounterStatus>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub episode_of_care: Vec<types::Reference<crate::r4b::resources::EpisodeOfCare>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub appointment: Vec<types::Reference<crate::r4b::resources::Appointment>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub account: Vec<types::Reference<crate::r4b::resources::Account>>,
    ...
    pub service_provider: Option<types::Reference<crate::r4b::resources::Organization>>,

    /// Another Encounter this encounter is part of
    pub part_of: Option<types::Reference<crate::r4b::resources::Encounter>>,
}
...
///
/// ```
/// use fhir::r4b::resources::encounter::EncounterClassHistory;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::encounter::EncounterDiagnosis;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::encounter::EncounterHospitalization;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::encounter::EncounterLocation;
/// use fhir::r4b::types;
///
...
pub struct EncounterLocation {
    ...
    pub location: types::Reference<crate::r4b::resources::Location>,

    /// planned | active | reserved | completed
    pub status: Option<crate::coded::Coded<crate::r4b::codes::EncounterLocationStatus>>,
    /// Primitive extension sibling for [`status`](Self::status) (FHIR `_status`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_status")]
    pub status_ext: Option<types::Element>,
...
///
/// ```
/// use fhir::r4b::resources::encounter::EncounterParticipant;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::encounter::EncounterStatusHistory;
/// use fhir::r4b::types;
///
