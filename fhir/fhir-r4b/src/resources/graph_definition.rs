...
///
/// ```
/// use fhir::r4b::resources::graph_definition::GraphDefinition;
/// use fhir::r4b::types;
///
...
pub struct GraphDefinition {
    ...
    pub start: crate::coded::Coded<crate::r4b::codes::ResourceTypes>,
...
///
/// ```
/// use fhir::r4b::resources::graph_definition::GraphDefinitionLink;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::graph_definition::GraphDefinitionLinkTarget;
/// use fhir::r4b::types;
///
/// let value = GraphDefinitionLinkTarget {
///     params: Some(types::String("abc".to_string())),
///     ..Default::default()
/// };
/// let json = ::serde_json::to_value(&value).unwrap();
/// // `params` is the name this serializes to on the wire.
/// assert_eq!(json["params"], ::serde_json::json!("abc"));
///
...
///
/// ```
/// use fhir::r4b::resources::graph_definition::GraphDefinitionLinkTargetCompartment;
/// use fhir::r4b::types;
///
/// let value = GraphDefinitionLinkTargetCompartment {
...
pub struct GraphDefinitionLinkTargetCompartment {
    ...
    pub r#use: crate::coded::Coded<crate::r4b::codes::GraphCompartmentUse>,
    ...
    pub code: crate::coded::Coded<crate::r4b::codes::CompartmentType>,
    ...
    pub rule: crate::coded::Coded<crate::r4b::codes::GraphCompartmentRule>,
