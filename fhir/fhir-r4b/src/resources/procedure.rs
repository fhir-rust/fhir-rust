...
///
/// ```
/// use fhir::r4b::resources::procedure::Procedure;
/// use fhir::r4b::types;
///
/// let value = Procedure {
...
pub struct Procedure {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub complication_detail: Vec<types::Reference<crate::r4b::resources::Condition>>,
...
///
/// ```
/// use fhir::r4b::resources::procedure::ProcedureFocalDevice;
/// use fhir::r4b::types;
///
...
pub struct ProcedureFocalDevice {
    ...
    pub manipulated: types::Reference<crate::r4b::resources::Device>,
}
...
///
/// ```
/// use fhir::r4b::resources::procedure::ProcedurePerformer;
/// use fhir::r4b::types;
///
