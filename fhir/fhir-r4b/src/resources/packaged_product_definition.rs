...
///
/// ```
/// use fhir::r4b::resources::packaged_product_definition::PackagedProductDefinition;
/// use fhir::r4b::types;
///
...
pub struct PackagedProductDefinition {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub package_for: Vec<types::Reference<crate::r4b::resources::MedicinalProductDefinition>>,
...
///
/// ```
/// use fhir::r4b::resources::packaged_product_definition::PackagedProductDefinitionLegalStatusOfSupply;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::packaged_product_definition::PackagedProductDefinitionPackage;
/// use fhir::r4b::types;
///
/// let value = PackagedProductDefinitionPackage {
...
///
/// let back: PackagedProductDefinitionPackage = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
#[derive(Debug, Default, Clone, Serialize, Deserialize, PartialEq, Eq, Validate)]
...
///
/// ```
/// use fhir::r4b::resources::packaged_product_definition::PackagedProductDefinitionPackageContainedItem;
/// use fhir::r4b::types;
///
/// let value = PackagedProductDefinitionPackageContainedItem {
///     id: Some(types::String("abc".to_string())),
///     ..Default::default()
/// };
/// let json = ::serde_json::to_value(&value).unwrap();
...
/// assert_eq!(json["id"], ::serde_json::json!("abc"));
///
/// let back: PackagedProductDefinitionPackageContainedItem = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
#[derive(Debug, Default, Clone, Serialize, Deserialize, PartialEq, Eq, Validate)]
...
///
/// ```
/// use fhir::r4b::resources::packaged_product_definition::PackagedProductDefinitionPackageProperty;
/// use fhir::r4b::types;
///
/// let value = PackagedProductDefinitionPackageProperty {
///     id: Some(types::String("abc".to_string())),
///     ..Default::default()
/// };
/// let json = ::serde_json::to_value(&value).unwrap();
...
/// assert_eq!(json["id"], ::serde_json::json!("abc"));
///
/// let back: PackagedProductDefinitionPackageProperty = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
#[derive(Debug, Default, Clone, Serialize, Deserialize, PartialEq, Eq, Validate)]
...
///
/// ```
/// use fhir::r4b::resources::packaged_product_definition::PackagedProductDefinitionPackageShelfLifeStorage;
/// use fhir::r4b::types;
///
/// let value = PackagedProductDefinitionPackageShelfLifeStorage {
///     id: Some(types::String("abc".to_string())),
///     ..Default::default()
/// };
/// let json = ::serde_json::to_value(&value).unwrap();
...
/// assert_eq!(json["id"], ::serde_json::json!("abc"));
///
/// let back: PackagedProductDefinitionPackageShelfLifeStorage = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
#[derive(Debug, Default, Clone, Serialize, Deserialize, PartialEq, Eq, Validate)]
...
pub struct PackagedProductDefinitionPackageShelfLifeStorage {
    ...
    /// used
    /// The `PackagedProductDefinition.package.shelfLifeStorage.period[x]` choice element (0..1); see [`PackagedProductDefinitionPackageShelfLifeStoragePeriod`].
    #[serde(flatten)]
...
/// The `PackagedProductDefinition.package.shelfLifeStorage.period[x]` choice element (see `spec/11-choice-types.md`).
#[derive(Debug, Clone, PartialEq, Eq, fhir_derive_macros::FhirChoice, Validate)]
#[fhir_version("r4b")]
#[allow(clippy::large_enum_variant)]
