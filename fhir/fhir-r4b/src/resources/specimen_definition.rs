...
///
/// ```
/// use fhir::r4b::resources::specimen_definition::SpecimenDefinition;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::specimen_definition::SpecimenDefinitionTypeTested;
/// use fhir::r4b::types;
///
...
pub struct SpecimenDefinitionTypeTested {
    ...
    /// preferred | alternate
    pub preference: crate::coded::Coded<crate::r4b::codes::SpecimenContainedPreference>,
...
///
/// ```
/// use fhir::r4b::resources::specimen_definition::SpecimenDefinitionTypeTestedContainer;
/// use fhir::r4b::types;
///
...
struct SpecimenDefinitionTypeTestedContainerDe {
    ...
    #[serde(flatten)]
    minimum_volume: crate::r4b::choice::Slot<SpecimenDefinitionTypeTestedContainerMinimumVolume>,
    #[serde(default)]
...
///
/// ```
/// use fhir::r4b::resources::specimen_definition::SpecimenDefinitionTypeTestedContainerAdditive;
/// use fhir::r4b::types;
///
...
struct SpecimenDefinitionTypeTestedContainerAdditiveDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    additive: crate::r4b::choice::Slot<SpecimenDefinitionTypeTestedContainerAdditiveAdditive>,
}
...
///
/// ```
/// use fhir::r4b::resources::specimen_definition::SpecimenDefinitionTypeTestedHandling;
/// use fhir::r4b::types;
///
