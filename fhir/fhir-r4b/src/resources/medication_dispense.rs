...
///
/// ```
/// use fhir::r4b::resources::medication_dispense::MedicationDispense;
/// use fhir::r4b::types;
///
...
pub struct MedicationDispense {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub part_of: Vec<types::Reference<crate::r4b::resources::Procedure>>,

    /// preparation | in-progress | cancelled | on-hold | completed |
    /// entered-in-error | stopped | declined | unknown
    pub status: crate::coded::Coded<crate::r4b::codes::MedicationdispenseStatus>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub authorizing_prescription: Vec<types::Reference<crate::r4b::resources::MedicationRequest>>,
...
struct MedicationDispenseDe {
    ...
    #[serde(default)]
    part_of: Vec<types::Reference<crate::r4b::resources::Procedure>>,
    status: crate::coded::Coded<crate::r4b::codes::MedicationdispenseStatus>,
    #[serde(rename = "_status")]
    status_ext: Option<types::Element>,
    #[serde(flatten)]
    status_reason: crate::r4b::choice::Slot<MedicationDispenseStatusReason>,
    category: Option<types::CodeableConcept>,
    #[serde(flatten)]
    medication: crate::r4b::choice::Slot<MedicationDispenseMedication>,
    ...
    #[serde(default)]
    authorizing_prescription: Vec<types::Reference<crate::r4b::resources::MedicationRequest>>,
...
///
/// ```
/// use fhir::r4b::resources::medication_dispense::MedicationDispensePerformer;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::medication_dispense::MedicationDispenseSubstitution;
/// use fhir::r4b::types;
///
