...
///
/// ```ignore
/// use fhir::r4b::resources::coverage_eligibility_request::CoverageEligibilityRequest;
///
...
pub struct CoverageEligibilityRequest {
    ...
    pub purpose: ::vec1::Vec1<crate::coded::Coded<crate::r4b::codes::EligibilityrequestPurpose>>,
...
struct CoverageEligibilityRequestDe {
    ...
    purpose: ::vec1::Vec1<crate::coded::Coded<crate::r4b::codes::EligibilityrequestPurpose>>,
    #[serde(rename = "_purpose")]
    #[serde(default)]
    purpose_ext: Vec<Option<types::Element>>,
    patient: types::Reference<crate::r4b::resources::Patient>,
    #[serde(flatten)]
    serviced: crate::r4b::choice::Slot<CoverageEligibilityRequestServiced>,
    ...
    facility: Option<types::Reference<crate::r4b::resources::Location>>,
    #[serde(default)]
...
///
/// ```
/// use fhir::r4b::resources::coverage_eligibility_request::CoverageEligibilityRequestInsurance;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::coverage_eligibility_request::CoverageEligibilityRequestItem;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::coverage_eligibility_request::CoverageEligibilityRequestItemDiagnosis;
/// use fhir::r4b::types;
///
...
struct CoverageEligibilityRequestItemDiagnosisDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    diagnosis: crate::r4b::choice::Slot<CoverageEligibilityRequestItemDiagnosisDiagnosis>,
}
...
///
/// ```
/// use fhir::r4b::resources::coverage_eligibility_request::CoverageEligibilityRequestSupportingInfo;
/// use fhir::r4b::types;
///
