...
///
/// ```
/// use fhir::r4b::resources::test_report::TestReport;
/// use fhir::r4b::types;
///
...
pub struct TestReport {
    ...
    pub status: crate::coded::Coded<crate::r4b::codes::ReportStatusCodes>,
    ...
    pub test_script: types::Reference<crate::r4b::resources::TestScript>,

    /// pass | fail | pending
    pub result: crate::coded::Coded<crate::r4b::codes::ReportResultCodes>,
...
///
/// ```
/// use fhir::r4b::resources::test_report::TestReportParticipant;
/// use fhir::r4b::types;
///
...
pub struct TestReportParticipant {
    ...
    pub r#type: crate::coded::Coded<crate::r4b::codes::ReportParticipantType>,
...
///
/// ```ignore
/// use fhir::r4b::resources::test_report::TestReportSetup;
///
...
///
/// ```
/// use fhir::r4b::resources::test_report::TestReportSetupAction;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::test_report::TestReportSetupActionAssert;
/// use fhir::r4b::types;
///
...
pub struct TestReportSetupActionAssert {
    ...
    pub result: crate::coded::Coded<crate::r4b::codes::ReportActionResultCodes>,
    /// Primitive extension sibling for [`result`](Self::result) (FHIR `_result`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_result")]
    pub result_ext: Option<types::Element>,
...
///
/// ```
/// use fhir::r4b::resources::test_report::TestReportSetupActionOperation;
/// use fhir::r4b::types;
///
...
///
/// ```ignore
/// use fhir::r4b::resources::test_report::TestReportTeardown;
///
...
///
/// ```
/// use fhir::r4b::resources::test_report::TestReportTeardownAction;
/// use fhir::r4b::types;
///
...
///
/// ```ignore
/// use fhir::r4b::resources::test_report::TestReportTest;
///
...
///
/// ```
/// use fhir::r4b::resources::test_report::TestReportTestAction;
/// use fhir::r4b::types;
///
