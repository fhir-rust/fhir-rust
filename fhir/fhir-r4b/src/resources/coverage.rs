...
///
/// ```ignore
/// use fhir::r4b::resources::coverage::Coverage;
///
...
pub struct Coverage {
    ...
    /// Plan beneficiary
    pub beneficiary: types::Reference<crate::r4b::resources::Patient>,
    ...
    /// Contract details
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub contract: Vec<types::Reference<crate::r4b::resources::Contract>>,
}
...
///
/// ```
/// use fhir::r4b::resources::coverage::CoverageClass;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::coverage::CoverageCostToBeneficiary;
/// use fhir::r4b::types;
///
...
struct CoverageCostToBeneficiaryDe {
    ...
    #[serde(flatten)]
    value: crate::r4b::choice::Slot<CoverageCostToBeneficiaryValue>,
    #[serde(default)]
...
///
/// ```
/// use fhir::r4b::resources::coverage::CoverageCostToBeneficiaryException;
/// use fhir::r4b::types;
///
