...
///
/// ```ignore
/// use fhir::r4b::resources::capability_statement::CapabilityStatement;
///
...
pub struct CapabilityStatement {
    ...
    pub kind: crate::coded::Coded<crate::r4b::codes::CapabilityStatementKind>,
    ...
    pub fhir_version: crate::coded::Coded<crate::r4b::codes::FhirVersion>,
...
///
/// ```
/// use fhir::r4b::resources::capability_statement::CapabilityStatementDocument;
/// use fhir::r4b::types;
///
...
pub struct CapabilityStatementDocument {
    ...
    /// producer | consumer
    pub mode: crate::coded::Coded<crate::r4b::codes::DocumentMode>,
...
///
/// ```
/// use fhir::r4b::resources::capability_statement::CapabilityStatementImplementation;
/// use fhir::r4b::types;
///
...
pub struct CapabilityStatementImplementation {
    ...
    pub custodian: Option<types::Reference<crate::r4b::resources::Organization>>,
}
...
///
/// ```
/// use fhir::r4b::resources::capability_statement::CapabilityStatementMessaging;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::capability_statement::CapabilityStatementMessagingEndpoint;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::capability_statement::CapabilityStatementMessagingSupportedMessage;
/// use fhir::r4b::types;
///
...
pub struct CapabilityStatementMessagingSupportedMessage {
    ...
    /// sender | receiver
    pub mode: crate::coded::Coded<crate::r4b::codes::EventCapabilityMode>,
    /// Primitive extension sibling for [`mode`](Self::mode) (FHIR `_mode`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_mode")]
    pub mode_ext: Option<types::Element>,
...
///
/// ```
/// use fhir::r4b::resources::capability_statement::CapabilityStatementRest;
/// use fhir::r4b::types;
///
...
pub struct CapabilityStatementRest {
    ...
    /// client | server
    pub mode: crate::coded::Coded<crate::r4b::codes::RestfulCapabilityMode>,
    /// Primitive extension sibling for [`mode`](Self::mode) (FHIR `_mode`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_mode")]
    pub mode_ext: Option<types::Element>,
...
///
/// ```
/// use fhir::r4b::resources::capability_statement::CapabilityStatementRestInteraction;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::capability_statement::CapabilityStatementRestResource;
/// use fhir::r4b::types;
///
...
pub struct CapabilityStatementRestResource {
    ...
    pub r#type: crate::coded::Coded<crate::r4b::codes::ResourceTypes>,
    ...
    pub versioning: Option<crate::coded::Coded<crate::r4b::codes::VersioningPolicy>>,
    ...
    pub conditional_read: Option<crate::coded::Coded<crate::r4b::codes::ConditionalReadStatus>>,
    ...
    pub conditional_delete: Option<crate::coded::Coded<crate::r4b::codes::ConditionalDeleteStatus>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub reference_policy: Vec<crate::coded::Coded<crate::r4b::codes::ReferenceHandlingPolicy>>,
...
///
/// ```
/// use fhir::r4b::resources::capability_statement::CapabilityStatementRestResourceInteraction;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::capability_statement::CapabilityStatementRestResourceOperation;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::capability_statement::CapabilityStatementRestResourceSearchParam;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::capability_statement::CapabilityStatementRestSecurity;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::capability_statement::CapabilityStatementSoftware;
/// use fhir::r4b::types;
///
