...
///
/// ```
/// use fhir::r4b::resources::charge_item_definition::ChargeItemDefinition;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::charge_item_definition::ChargeItemDefinitionApplicability;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::charge_item_definition::ChargeItemDefinitionPropertyGroup;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::charge_item_definition::ChargeItemDefinitionPropertyGroupPriceComponent;
/// use fhir::r4b::types;
///
/// let value = ChargeItemDefinitionPropertyGroupPriceComponent {
///     id: Some(types::String("abc".to_string())),
///     ..Default::default()
/// };
/// let json = ::serde_json::to_value(&value).unwrap();
