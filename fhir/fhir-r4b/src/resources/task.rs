...
///
/// ```
/// use fhir::r4b::resources::task::Task;
/// use fhir::r4b::types;
///
/// let value = Task {
...
pub struct Task {
    ...
    /// Composite task
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub part_of: Vec<types::Reference<crate::r4b::resources::Task>>,

    /// draft | requested | received | accepted | +
    pub status: crate::coded::Coded<crate::r4b::codes::TaskStatus>,
    ...
    pub intent: crate::coded::Coded<crate::r4b::codes::TaskIntent>,
...
///
/// ```
/// use fhir::r4b::resources::task::TaskInput;
/// use fhir::r4b::types;
///
/// let value = TaskInput {
...
struct TaskInputDe {
    ...
    #[serde(flatten)]
    value: crate::r4b::choice::Slot<TaskInputValue>,
}
...
///
/// ```
/// use fhir::r4b::resources::task::TaskOutput;
/// use fhir::r4b::types;
///
...
struct TaskOutputDe {
    ...
    r#type: types::CodeableConcept,
    #[serde(flatten)]
    value: crate::r4b::choice::Slot<TaskOutputValue>,
}
...
///
/// ```
/// use fhir::r4b::resources::task::TaskRestriction;
/// use fhir::r4b::types;
///
