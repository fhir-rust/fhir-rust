...
struct DiagnosticReportDe {
    ...
    status: crate::coded::Coded<crate::r4b::codes::DiagnosticReportStatus>,
    #[serde(rename = "_status")]
    ...
    #[serde(flatten)]
    effective: crate::r4b::choice::Slot<DiagnosticReportEffective>,
    ...
    #[serde(default)]
    result: Vec<types::Reference<crate::r4b::resources::Observation>>,
    #[serde(default)]
    imaging_study: Vec<types::Reference<crate::r4b::resources::ImagingStudy>>,
    #[serde(default)]
