...
///
/// ```
/// use fhir::r4b::resources::list::List;
/// use fhir::r4b::types;
///
/// let value = List {
...
pub struct List {
    ...
    pub status: crate::coded::Coded<crate::r4b::codes::ListStatus>,
    ...
    pub mode: crate::coded::Coded<crate::r4b::codes::ListMode>,
...
///
/// ```
/// use fhir::r4b::resources::list::ListEntry;
/// use fhir::r4b::types;
///
/// let value = ListEntry {
