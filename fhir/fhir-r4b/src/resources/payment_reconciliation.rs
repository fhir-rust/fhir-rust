...
///
/// ```
/// use fhir::r4b::resources::payment_reconciliation::PaymentReconciliation;
/// use fhir::r4b::types;
///
...
pub struct PaymentReconciliation {
    ...
    pub payment_issuer: Option<types::Reference<crate::r4b::resources::Organization>>,

    /// Reference to requesting resource
    pub request: Option<types::Reference<crate::r4b::resources::Task>>,

    /// Responsible practitioner
    pub requestor: Option<types::Reference>,

    /// queued | complete | error | partial
    pub outcome: Option<crate::coded::Coded<crate::r4b::codes::RemittanceOutcome>>,
...
///
/// ```
/// use fhir::r4b::resources::payment_reconciliation::PaymentReconciliationDetail;
/// use fhir::r4b::types;
///
...
pub struct PaymentReconciliationDetail {
    ...
    pub responsible: Option<types::Reference<crate::r4b::resources::PractitionerRole>>,
...
///
/// ```
/// use fhir::r4b::resources::payment_reconciliation::PaymentReconciliationProcessNote;
/// use fhir::r4b::types;
///
