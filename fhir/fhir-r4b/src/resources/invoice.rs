...
///
/// ```
/// use fhir::r4b::resources::invoice::Invoice;
/// use fhir::r4b::types;
///
/// let value = Invoice {
...
pub struct Invoice {
    ...
    pub status: crate::coded::Coded<crate::r4b::codes::InvoiceStatus>,
    ...
    pub issuer: Option<types::Reference<crate::r4b::resources::Organization>>,

    /// Account that is being balanced
    pub account: Option<types::Reference<crate::r4b::resources::Account>>,
...
///
/// ```
/// use fhir::r4b::resources::invoice::InvoiceLineItem;
/// use fhir::r4b::types;
///
...
struct InvoiceLineItemDe {
    ...
    #[serde(flatten)]
    charge_item: crate::r4b::choice::Slot<InvoiceLineItemChargeItem>,
    #[serde(default)]
...
///
/// ```
/// use fhir::r4b::resources::invoice::InvoiceLineItemPriceComponent;
/// use fhir::r4b::types;
///
...
pub struct InvoiceLineItemPriceComponent {
    ...
    pub r#type: crate::coded::Coded<crate::r4b::codes::InvoicePriceComponentType>,
...
///
/// ```
/// use fhir::r4b::resources::invoice::InvoiceParticipant;
/// use fhir::r4b::types;
///
