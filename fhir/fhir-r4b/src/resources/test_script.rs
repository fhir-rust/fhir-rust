...
///
/// ```
/// use fhir::r4b::resources::test_script::TestScript;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::test_script::TestScriptDestination;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::test_script::TestScriptFixture;
/// use fhir::r4b::types;
///
...
///
/// ```ignore
/// use fhir::r4b::resources::test_script::TestScriptMetadata;
///
...
///
/// ```
/// use fhir::r4b::resources::test_script::TestScriptMetadataCapability;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::test_script::TestScriptMetadataLink;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::test_script::TestScriptOrigin;
/// use fhir::r4b::types;
///
...
///
/// ```ignore
/// use fhir::r4b::resources::test_script::TestScriptSetup;
///
...
///
/// ```
/// use fhir::r4b::resources::test_script::TestScriptSetupAction;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::test_script::TestScriptSetupActionAssert;
/// use fhir::r4b::types;
///
...
pub struct TestScriptSetupActionAssert {
    ...
    /// response | request
    pub direction: Option<crate::coded::Coded<crate::r4b::codes::AssertDirectionCodes>>,
    ...
    pub operator: Option<crate::coded::Coded<crate::r4b::codes::AssertOperatorCodes>>,
    ...
    pub request_method: Option<crate::coded::Coded<crate::r4b::codes::HttpOperations>>,
    ...
    pub response: Option<crate::coded::Coded<crate::r4b::codes::AssertResponseCodeTypes>>,
...
///
/// ```
/// use fhir::r4b::resources::test_script::TestScriptSetupActionOperation;
/// use fhir::r4b::types;
///
...
pub struct TestScriptSetupActionOperation {
    ...
    /// delete | get | options | patch | post | put | head
    pub method: Option<crate::coded::Coded<crate::r4b::codes::HttpOperations>>,
...
///
/// ```
/// use fhir::r4b::resources::test_script::TestScriptSetupActionOperationRequestHeader;
/// use fhir::r4b::types;
///
...
///
/// ```ignore
/// use fhir::r4b::resources::test_script::TestScriptTeardown;
///
...
///
/// ```
/// use fhir::r4b::resources::test_script::TestScriptTeardownAction;
/// use fhir::r4b::types;
///
...
///
/// ```ignore
/// use fhir::r4b::resources::test_script::TestScriptTest;
///
...
///
/// ```
/// use fhir::r4b::resources::test_script::TestScriptTestAction;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::test_script::TestScriptVariable;
/// use fhir::r4b::types;
///
