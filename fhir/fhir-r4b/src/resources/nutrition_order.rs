...
///
/// ```
/// use fhir::r4b::resources::nutrition_order::NutritionOrder;
/// use fhir::r4b::types;
///
...
pub struct NutritionOrder {
    ...
    /// intolerances
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub allergy_intolerance: Vec<types::Reference<crate::r4b::resources::AllergyIntolerance>>,
...
///
/// ```
/// use fhir::r4b::resources::nutrition_order::NutritionOrderEnteralFormula;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::nutrition_order::NutritionOrderEnteralFormulaAdministration;
/// use fhir::r4b::types;
///
...
struct NutritionOrderEnteralFormulaAdministrationDe {
    ...
    #[serde(flatten)]
    rate: crate::r4b::choice::Slot<NutritionOrderEnteralFormulaAdministrationRate>,
}
...
///
/// ```
/// use fhir::r4b::resources::nutrition_order::NutritionOrderOralDiet;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::nutrition_order::NutritionOrderOralDietNutrient;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::nutrition_order::NutritionOrderOralDietTexture;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::nutrition_order::NutritionOrderSupplement;
/// use fhir::r4b::types;
///
