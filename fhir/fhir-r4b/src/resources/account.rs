...
///
/// ```
/// use fhir::r4b::resources::account::Account;
/// use fhir::r4b::types;
///
/// let value = Account {
...
pub struct Account {
    ...
    pub status: crate::coded::Coded<crate::r4b::codes::AccountStatus>,
    ...
    pub part_of: Option<types::Reference<crate::r4b::resources::Account>>,
}
...
///
/// ```
/// use fhir::r4b::resources::account::AccountCoverage;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::account::AccountGuarantor;
/// use fhir::r4b::types;
///
