...
///
/// ```
/// use fhir::r4b::resources::regulated_authorization::RegulatedAuthorization;
/// use fhir::r4b::types;
///
...
pub struct RegulatedAuthorization {
    ...
    pub indication: Option<types::CodeableReference>,
    ...
    /// regulator
    pub holder: Option<types::Reference<crate::r4b::resources::Organization>>,

    /// The regulatory authority or authorizing body granting the authorization
    pub regulator: Option<types::Reference<crate::r4b::resources::Organization>>,
...
///
/// ```
/// use fhir::r4b::resources::regulated_authorization::RegulatedAuthorizationCase;
/// use fhir::r4b::types;
///
...
struct RegulatedAuthorizationCaseDe {
    ...
    #[serde(flatten)]
    date: crate::r4b::choice::Slot<RegulatedAuthorizationCaseDate>,
    #[serde(default)]
