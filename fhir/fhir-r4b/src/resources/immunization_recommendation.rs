...
///
/// ```ignore
/// use fhir::r4b::resources::immunization_recommendation::ImmunizationRecommendation;
///
...
///
/// ```
/// use fhir::r4b::resources::immunization_recommendation::ImmunizationRecommendationRecommendation;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::immunization_recommendation::ImmunizationRecommendationRecommendationDateCriterion;
/// use fhir::r4b::types;
///
