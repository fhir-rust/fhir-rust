...
///
/// ```
/// use fhir::r4b::resources::organization_affiliation::OrganizationAffiliation;
/// use fhir::r4b::types;
///
...
pub struct OrganizationAffiliation {
    ...
    /// or is a member of)
    pub participating_organization: Option<types::Reference<crate::r4b::resources::Organization>>,
