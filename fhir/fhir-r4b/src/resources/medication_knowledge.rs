...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledge;
/// use fhir::r4b::types;
///
...
pub struct MedicationKnowledge {
    ...
    pub status: Option<crate::coded::Coded<crate::r4b::codes::MedicationknowledgeStatus>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub associated_medication: Vec<types::Reference<crate::r4b::resources::Medication>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub contraindication: Vec<types::Reference<crate::r4b::resources::DetectedIssue>>,
...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeAdministrationGuidelines;
/// use fhir::r4b::types;
///
...
struct MedicationKnowledgeAdministrationGuidelinesDe {
    ...
    #[serde(flatten)]
    indication: crate::r4b::choice::Slot<MedicationKnowledgeAdministrationGuidelinesIndication>,
    #[serde(default)]
...
///
/// ```ignore
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeAdministrationGuidelinesDosage;
///
...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics;
/// use fhir::r4b::types;
///
...
struct MedicationKnowledgeAdministrationGuidelinesPatientCharacteristicsDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    characteristic: crate::r4b::choice::Slot<
...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeCost;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeDrugCharacteristic;
/// use fhir::r4b::types;
///
...
struct MedicationKnowledgeDrugCharacteristicDe {
    ...
    #[serde(flatten)]
    value: crate::r4b::choice::Slot<MedicationKnowledgeDrugCharacteristicValue>,
}
...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeIngredient;
/// use fhir::r4b::types;
///
...
struct MedicationKnowledgeIngredientDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    item: crate::r4b::choice::Slot<MedicationKnowledgeIngredientItem>,
...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeKinetics;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeMedicineClassification;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeMonitoringProgram;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeMonograph;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgePackaging;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeRegulatory;
/// use fhir::r4b::types;
///
...
pub struct MedicationKnowledgeRegulatory {
    ...
    pub regulatory_authority: types::Reference<crate::r4b::resources::Organization>,
...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeRegulatoryMaxDispense;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeRegulatorySchedule;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeRegulatorySubstitution;
/// use fhir::r4b::types;
///
...
///
/// ```ignore
/// use fhir::r4b::resources::medication_knowledge::MedicationKnowledgeRelatedMedicationKnowledge;
///
...
pub struct MedicationKnowledgeRelatedMedicationKnowledge {
    ...
    pub reference: ::vec1::Vec1<types::Reference<crate::r4b::resources::MedicationKnowledge>>,
}
