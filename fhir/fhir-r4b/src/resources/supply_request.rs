...
///
/// ```
/// use fhir::r4b::resources::supply_request::SupplyRequest;
/// use fhir::r4b::types;
///
...
pub struct SupplyRequest {
    ...
    pub status: Option<crate::coded::Coded<crate::r4b::codes::SupplyrequestStatus>>,
...
///
/// ```
/// use fhir::r4b::resources::supply_request::SupplyRequestParameter;
/// use fhir::r4b::types;
///
