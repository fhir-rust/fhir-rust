...
///
/// ```ignore
/// use fhir::r4b::resources::provenance::Provenance;
///
...
struct ProvenanceDe {
    ...
    #[serde(flatten)]
    occurred: crate::r4b::choice::Slot<ProvenanceOccurred>,
...
///
/// ```
/// use fhir::r4b::resources::provenance::ProvenanceAgent;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::provenance::ProvenanceEntity;
/// use fhir::r4b::types;
///
...
pub struct ProvenanceEntity {
    ...
    pub role: crate::coded::Coded<crate::r4b::codes::ProvenanceEntityRole>,
