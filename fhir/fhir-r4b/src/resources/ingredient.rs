...
struct IngredientSubstanceStrengthDe {
    ...
    #[serde(flatten)]
    presentation: crate::r4b::choice::Slot<IngredientSubstanceStrengthPresentation>,
    text_presentation: Option<types::String>,
    #[serde(rename = "_textPresentation")]
    text_presentation_ext: Option<types::Element>,
    #[serde(flatten)]
    concentration: crate::r4b::choice::Slot<IngredientSubstanceStrengthConcentration>,
...
struct IngredientSubstanceStrengthReferenceStrengthDe {
    ...
    #[serde(default)]
    modifier_extension: Vec<types::Extension>,
    substance: Option<types::CodeableReference>,
    #[serde(flatten)]
    strength: crate::r4b::choice::Slot<IngredientSubstanceStrengthReferenceStrengthStrength>,
    measurement_point: Option<types::String>,
    #[serde(rename = "_measurementPoint")]
    measurement_point_ext: Option<types::Element>,
    #[serde(default)]
