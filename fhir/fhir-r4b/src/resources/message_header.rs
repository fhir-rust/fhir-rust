...
///
/// ```
/// use fhir::r4b::resources::message_header::MessageHeader;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::message_header::MessageHeaderDestination;
/// use fhir::r4b::types;
///
...
pub struct MessageHeaderDestination {
    ...
    pub target: Option<types::Reference<crate::r4b::resources::Device>>,
...
///
/// ```
/// use fhir::r4b::resources::message_header::MessageHeaderResponse;
/// use fhir::r4b::types;
///
...
pub struct MessageHeaderResponse {
    ...
    pub code: crate::coded::Coded<crate::r4b::codes::ResponseCode>,
    ...
    pub details: Option<types::Reference<crate::r4b::resources::OperationOutcome>>,
}
...
///
/// ```
/// use fhir::r4b::resources::message_header::MessageHeaderSource;
/// use fhir::r4b::types;
///
