...
///
/// ```ignore
/// use fhir::r4b::resources::claim::Claim;
///
...
pub struct Claim {
    ...
    pub status: crate::coded::Coded<crate::r4b::codes::FmStatus>,
...
///
/// ```
/// use fhir::r4b::resources::claim::ClaimAccident;
/// use fhir::r4b::types;
///
...
struct ClaimAccidentDe {
    ...
    #[serde(flatten)]
    location: crate::r4b::choice::Slot<ClaimAccidentLocation>,
}
...
///
/// ```
/// use fhir::r4b::resources::claim::ClaimCareTeam;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::claim::ClaimDiagnosis;
/// use fhir::r4b::types;
///
...
struct ClaimDiagnosisDe {
    ...
    #[serde(flatten)]
    diagnosis: crate::r4b::choice::Slot<ClaimDiagnosisDiagnosis>,
    #[serde(default)]
...
///
/// ```
/// use fhir::r4b::resources::claim::ClaimInsurance;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::claim::ClaimItem;
/// use fhir::r4b::types;
///
/// let value = ClaimItem {
///     id: Some(types::String("abc".to_string())),
...
struct ClaimItemDe {
    ...
    #[serde(flatten)]
    serviced: crate::r4b::choice::Slot<ClaimItemServiced>,
    #[serde(flatten)]
    location: crate::r4b::choice::Slot<ClaimItemLocation>,
...
///
/// ```
/// use fhir::r4b::resources::claim::ClaimItemDetail;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::claim::ClaimItemDetailSubDetail;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::claim::ClaimPayee;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::claim::ClaimProcedure;
/// use fhir::r4b::types;
///
...
struct ClaimProcedureDe {
    ...
    date_ext: Option<types::Element>,
    #[serde(flatten)]
    procedure: crate::r4b::choice::Slot<ClaimProcedureProcedure>,
    #[serde(default)]
    udi: Vec<types::Reference<crate::r4b::resources::Device>>,
}
...
///
/// ```
/// use fhir::r4b::resources::claim::ClaimRelated;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::claim::ClaimSupportingInfo;
/// use fhir::r4b::types;
///
...
struct ClaimSupportingInfoDe {
    ...
    #[serde(flatten)]
    timing: crate::r4b::choice::Slot<ClaimSupportingInfoTiming>,
    #[serde(flatten)]
    value: crate::r4b::choice::Slot<ClaimSupportingInfoValue>,
