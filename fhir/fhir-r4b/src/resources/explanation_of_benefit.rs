...
///
/// ```ignore
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefit;
///
...
pub struct ExplanationOfBenefit {
    ...
    pub status: crate::coded::Coded<crate::r4b::codes::ExplanationofbenefitStatus>,
    ...
    pub r#use: crate::coded::Coded<crate::r4b::codes::ClaimUse>,
    ...
    pub insurer: types::Reference<crate::r4b::resources::Organization>,
    ...
    pub original_prescription: Option<types::Reference<crate::r4b::resources::MedicationRequest>>,

    /// Recipient of benefits payable
    pub payee: Option<ExplanationOfBenefitPayee>,

    /// Treatment Referral
    pub referral: Option<types::Reference<crate::r4b::resources::ServiceRequest>>,

    /// Servicing Facility
    pub facility: Option<types::Reference<crate::r4b::resources::Location>>,

    /// Claim reference
    pub claim: Option<types::Reference<crate::r4b::resources::Claim>>,

    /// Claim response reference
    pub claim_response: Option<types::Reference<crate::r4b::resources::ClaimResponse>>,

    /// queued | complete | error | partial
    pub outcome: crate::coded::Coded<crate::r4b::codes::RemittanceOutcome>,
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitAccident;
/// use fhir::r4b::types;
///
...
struct ExplanationOfBenefitAccidentDe {
    ...
    #[serde(flatten)]
    location: crate::r4b::choice::Slot<ExplanationOfBenefitAccidentLocation>,
}
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitAddItem;
/// use fhir::r4b::types;
///
...
struct ExplanationOfBenefitAddItemDe {
    ...
    #[serde(flatten)]
    serviced: crate::r4b::choice::Slot<ExplanationOfBenefitAddItemServiced>,
    #[serde(flatten)]
    location: crate::r4b::choice::Slot<ExplanationOfBenefitAddItemLocation>,
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitAddItemDetail;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitAddItemDetailSubDetail;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitBenefitBalance;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitBenefitBalanceFinancial;
/// use fhir::r4b::types;
///
...
struct ExplanationOfBenefitBenefitBalanceFinancialDe {
    ...
    #[serde(flatten)]
    allowed: crate::r4b::choice::Slot<ExplanationOfBenefitBenefitBalanceFinancialAllowed>,
    #[serde(flatten)]
    used: crate::r4b::choice::Slot<ExplanationOfBenefitBenefitBalanceFinancialUsed>,
}
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitCareTeam;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitDiagnosis;
/// use fhir::r4b::types;
///
...
struct ExplanationOfBenefitDiagnosisDe {
    ...
    #[serde(flatten)]
    diagnosis: crate::r4b::choice::Slot<ExplanationOfBenefitDiagnosisDiagnosis>,
    #[serde(default)]
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitInsurance;
/// use fhir::r4b::types;
///
...
pub struct ExplanationOfBenefitInsurance {
    ...
    pub coverage: types::Reference<crate::r4b::resources::Coverage>,
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitItem;
/// use fhir::r4b::types;
///
...
pub struct ExplanationOfBenefitItem {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub udi: Vec<types::Reference<crate::r4b::resources::Device>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub encounter: Vec<types::Reference<crate::r4b::resources::Encounter>>,
...
struct ExplanationOfBenefitItemDe {
    ...
    program_code: Vec<types::CodeableConcept>,
    #[serde(flatten)]
    serviced: crate::r4b::choice::Slot<ExplanationOfBenefitItemServiced>,
    #[serde(flatten)]
    location: crate::r4b::choice::Slot<ExplanationOfBenefitItemLocation>,
    quantity: Option<types::Quantity>,
    unit_price: Option<types::Money>,
    factor: Option<types::Decimal>,
    #[serde(rename = "_factor")]
    ...
    net: Option<types::Money>,
    #[serde(default)]
    udi: Vec<types::Reference<crate::r4b::resources::Device>>,
    body_site: Option<types::CodeableConcept>,
    #[serde(default)]
    sub_site: Vec<types::CodeableConcept>,
    #[serde(default)]
    encounter: Vec<types::Reference<crate::r4b::resources::Encounter>>,
    #[serde(default)]
    note_number: ::fhir_core::PrimVec<types::PositiveInt>,
    #[serde(rename = "_noteNumber")]
    #[serde(default)]
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitItemAdjudication;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitItemDetail;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitItemDetailSubDetail;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitPayee;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitPayment;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitProcedure;
/// use fhir::r4b::types;
///
...
struct ExplanationOfBenefitProcedureDe {
    ...
    date_ext: Option<types::Element>,
    #[serde(flatten)]
    procedure: crate::r4b::choice::Slot<ExplanationOfBenefitProcedureProcedure>,
    #[serde(default)]
    udi: Vec<types::Reference<crate::r4b::resources::Device>>,
}
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitProcessNote;
/// use fhir::r4b::types;
///
...
pub struct ExplanationOfBenefitProcessNote {
    ...
    pub r#type: Option<crate::coded::Coded<crate::r4b::codes::NoteType>>,
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitRelated;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitSupportingInfo;
/// use fhir::r4b::types;
///
...
struct ExplanationOfBenefitSupportingInfoDe {
    ...
    #[serde(flatten)]
    timing: crate::r4b::choice::Slot<ExplanationOfBenefitSupportingInfoTiming>,
    #[serde(flatten)]
    value: crate::r4b::choice::Slot<ExplanationOfBenefitSupportingInfoValue>,
...
///
/// ```
/// use fhir::r4b::resources::explanation_of_benefit::ExplanationOfBenefitTotal;
/// use fhir::r4b::types;
///
