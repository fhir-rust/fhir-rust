...
///
/// ```
/// use fhir::r4b::resources::device::Device;
/// use fhir::r4b::types;
///
/// let value = Device {
...
pub struct Device {
    ...
    pub definition: Option<types::Reference<crate::r4b::resources::DeviceDefinition>>,
    ...
    pub status: Option<crate::coded::Coded<crate::r4b::codes::DeviceStatus>>,
    ...
    pub parent: Option<types::Reference<crate::r4b::resources::Device>>,
}
...
///
/// ```
/// use fhir::r4b::resources::device::DeviceDeviceName;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::device::DeviceProperty;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::device::DeviceSpecialization;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::device::DeviceUdiCarrier;
/// use fhir::r4b::types;
///
...
pub struct DeviceUdiCarrier {
    ...
    /// barcode | rfid | manual +
    pub entry_type: Option<crate::coded::Coded<crate::r4b::codes::UdiEntryType>>,
...
///
/// ```
/// use fhir::r4b::resources::device::DeviceVersion;
/// use fhir::r4b::types;
///
