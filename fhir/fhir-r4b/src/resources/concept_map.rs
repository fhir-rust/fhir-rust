...
///
/// ```
/// use fhir::r4b::resources::concept_map::ConceptMap;
/// use fhir::r4b::types;
///
...
struct ConceptMapDe {
    ...
    #[serde(flatten)]
    source: crate::r4b::choice::Slot<ConceptMapSource>,
    #[serde(flatten)]
    target: crate::r4b::choice::Slot<ConceptMapTarget>,
    #[serde(default)]
...
///
/// ```ignore
/// use fhir::r4b::resources::concept_map::ConceptMapGroup;
///
...
///
/// ```
/// use fhir::r4b::resources::concept_map::ConceptMapGroupElement;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::concept_map::ConceptMapGroupElementTarget;
/// use fhir::r4b::types;
///
...
pub struct ConceptMapGroupElementTarget {
    ...
    pub equivalence: crate::coded::Coded<crate::r4b::codes::ConceptMapEquivalence>,
...
///
/// ```
/// use fhir::r4b::resources::concept_map::ConceptMapGroupElementTargetDependsOn;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::concept_map::ConceptMapGroupUnmapped;
/// use fhir::r4b::types;
///
...
pub struct ConceptMapGroupUnmapped {
    ...
    pub mode: crate::coded::Coded<crate::r4b::codes::ConceptmapUnmappedMode>,
