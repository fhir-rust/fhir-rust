...
///
/// ```ignore
/// use fhir::r4b::resources::vision_prescription::VisionPrescription;
///
...
///
/// ```
/// use fhir::r4b::resources::vision_prescription::VisionPrescriptionLensSpecification;
/// use fhir::r4b::types;
///
...
pub struct VisionPrescriptionLensSpecification {
    ...
    /// right | left
    pub eye: crate::coded::Coded<crate::r4b::codes::VisionEyeCodes>,
...
///
/// ```
/// use fhir::r4b::resources::vision_prescription::VisionPrescriptionLensSpecificationPrism;
/// use fhir::r4b::types;
///
...
pub struct VisionPrescriptionLensSpecificationPrism {
    ...
    /// up | down | in | out
    pub base: crate::coded::Coded<crate::r4b::codes::VisionBaseCodes>,
