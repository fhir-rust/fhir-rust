...
///
/// ```
/// use fhir::r4b::resources::substance_definition::SubstanceDefinition;
/// use fhir::r4b::types;
///
...
pub struct SubstanceDefinition {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub information_source: Vec<types::Reference<crate::r4b::resources::Citation>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub supplier: Vec<types::Reference<crate::r4b::resources::Organization>>,
...
///
/// ```
/// use fhir::r4b::resources::substance_definition::SubstanceDefinitionCode;
/// use fhir::r4b::types;
///
...
pub struct SubstanceDefinitionCode {
    ...
    /// Supporting literature
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub source: Vec<types::Reference<crate::r4b::resources::DocumentReference>>,
}
...
///
/// ```
/// use fhir::r4b::resources::substance_definition::SubstanceDefinitionMoiety;
/// use fhir::r4b::types;
///
...
struct SubstanceDefinitionMoietyDe {
    ...
    #[serde(flatten)]
    amount: crate::r4b::choice::Slot<SubstanceDefinitionMoietyAmount>,
...
///
/// ```
/// use fhir::r4b::resources::substance_definition::SubstanceDefinitionMolecularWeight;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::substance_definition::SubstanceDefinitionName;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::substance_definition::SubstanceDefinitionNameOfficial;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::substance_definition::SubstanceDefinitionProperty;
/// use fhir::r4b::types;
///
...
struct SubstanceDefinitionPropertyDe {
    ...
    #[serde(flatten)]
    value: crate::r4b::choice::Slot<SubstanceDefinitionPropertyValue>,
}
...
///
/// ```
/// use fhir::r4b::resources::substance_definition::SubstanceDefinitionRelationship;
/// use fhir::r4b::types;
///
...
struct SubstanceDefinitionRelationshipDe {
    ...
    substance_definition:
        crate::r4b::choice::Slot<SubstanceDefinitionRelationshipSubstanceDefinition>,
    r#type: types::CodeableConcept,
    is_defining: Option<types::Boolean>,
    #[serde(rename = "_isDefining")]
    is_defining_ext: Option<types::Element>,
    #[serde(flatten)]
    amount: crate::r4b::choice::Slot<SubstanceDefinitionRelationshipAmount>,
    ratio_high_limit_amount: Option<types::Ratio>,
    comparator: Option<types::CodeableConcept>,
    #[serde(default)]
    source: Vec<types::Reference<crate::r4b::resources::DocumentReference>>,
}
...
///
/// ```
/// use fhir::r4b::resources::substance_definition::SubstanceDefinitionSourceMaterial;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::substance_definition::SubstanceDefinitionStructure;
/// use fhir::r4b::types;
///
...
pub struct SubstanceDefinitionStructure {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub source_document: Vec<types::Reference<crate::r4b::resources::DocumentReference>>,
...
///
/// ```
/// use fhir::r4b::resources::substance_definition::SubstanceDefinitionStructureRepresentation;
/// use fhir::r4b::types;
///
...
pub struct SubstanceDefinitionStructureRepresentation {
    ...
    pub document: Option<types::Reference<crate::r4b::resources::DocumentReference>>,
}
