...
///
/// ```
/// use fhir::r4b::resources::person::Person;
/// use fhir::r4b::types;
///
/// let value = Person {
...
///
/// ```
/// use fhir::r4b::resources::person::PersonLink;
/// use fhir::r4b::types;
///
...
pub struct PersonLink {
    ...
    pub assurance: Option<crate::coded::Coded<crate::r4b::codes::IdentityAssuranceLevel>>,
