...
///
/// ```
/// use fhir::r4b::resources::observation::Observation;
/// use fhir::r4b::types;
///
...
struct ObservationDe {
    ...
    #[serde(flatten)]
    effective: crate::r4b::choice::Slot<ObservationEffective>,
    ...
    #[serde(flatten)]
    value: crate::r4b::choice::Slot<ObservationValue>,
    ...
    specimen: Option<types::Reference<crate::r4b::resources::Specimen>>,
...
///
/// ```
/// use fhir::r4b::resources::observation::ObservationComponent;
/// use fhir::r4b::types;
///
...
struct ObservationComponentDe {
    ...
    code: types::CodeableConcept,
    #[serde(flatten)]
    value: crate::r4b::choice::Slot<ObservationComponentValue>,
    data_absent_reason: Option<types::CodeableConcept>,
    #[serde(default)]
    interpretation: Vec<types::CodeableConcept>,
    #[serde(default)]
...
///
/// ```
/// use fhir::r4b::resources::observation::ObservationReferenceRange;
/// use fhir::r4b::types;
///
