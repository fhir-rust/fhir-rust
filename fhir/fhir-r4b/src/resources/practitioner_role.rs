...
///
/// ```
/// use fhir::r4b::resources::practitioner_role::PractitionerRole;
/// use fhir::r4b::types;
///
...
pub struct PractitionerRole {
    ...
    /// organization
    pub practitioner: Option<types::Reference<crate::r4b::resources::Practitioner>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub healthcare_service: Vec<types::Reference<crate::r4b::resources::HealthcareService>>,
...
///
/// ```
/// use fhir::r4b::resources::practitioner_role::PractitionerRoleAvailableTime;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::practitioner_role::PractitionerRoleNotAvailable;
/// use fhir::r4b::types;
///
