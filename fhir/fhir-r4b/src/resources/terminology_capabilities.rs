...
///
/// ```
/// use fhir::r4b::resources::terminology_capabilities::TerminologyCapabilities;
/// use fhir::r4b::types;
///
...
pub struct TerminologyCapabilities {
    ...
    /// explicit | all
    pub code_search: Option<crate::coded::Coded<crate::r4b::codes::CodeSearchSupport>>,
...
///
/// ```
/// use fhir::r4b::resources::terminology_capabilities::TerminologyCapabilitiesClosure;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::terminology_capabilities::TerminologyCapabilitiesCodeSystem;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::terminology_capabilities::TerminologyCapabilitiesCodeSystemVersion;
/// use fhir::r4b::types;
///
...
///
/// ```ignore
/// use fhir::r4b::resources::terminology_capabilities::TerminologyCapabilitiesCodeSystemVersionFilter;
///
...
///
/// ```
/// use fhir::r4b::resources::terminology_capabilities::TerminologyCapabilitiesExpansion;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::terminology_capabilities::TerminologyCapabilitiesExpansionParameter;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::terminology_capabilities::TerminologyCapabilitiesImplementation;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::terminology_capabilities::TerminologyCapabilitiesSoftware;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::terminology_capabilities::TerminologyCapabilitiesTranslation;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::terminology_capabilities::TerminologyCapabilitiesValidateCode;
/// use fhir::r4b::types;
///
