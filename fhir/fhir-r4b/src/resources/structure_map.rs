...
///
/// ```ignore
/// use fhir::r4b::resources::structure_map::StructureMap;
///
...
///
/// ```ignore
/// use fhir::r4b::resources::structure_map::StructureMapGroup;
///
...
pub struct StructureMapGroup {
    ...
    pub type_mode: crate::coded::Coded<crate::r4b::codes::MapGroupTypeMode>,
...
///
/// ```
/// use fhir::r4b::resources::structure_map::StructureMapGroupInput;
/// use fhir::r4b::types;
///
...
pub struct StructureMapGroupInput {
    ...
    /// source | target
    pub mode: crate::coded::Coded<crate::r4b::codes::MapInputMode>,
...
///
/// ```ignore
/// use fhir::r4b::resources::structure_map::StructureMapGroupRule;
///
...
///
/// ```ignore
/// use fhir::r4b::resources::structure_map::StructureMapGroupRuleDependent;
///
...
///
/// ```
/// use fhir::r4b::resources::structure_map::StructureMapGroupRuleSource;
/// use fhir::r4b::types;
///
...
pub struct StructureMapGroupRuleSource {
    ...
    pub list_mode: Option<crate::coded::Coded<crate::r4b::codes::MapSourceListMode>>,
...
///
/// ```
/// use fhir::r4b::resources::structure_map::StructureMapGroupRuleTarget;
/// use fhir::r4b::types;
///
...
pub struct StructureMapGroupRuleTarget {
    ...
    /// type | variable
    pub context_type: Option<crate::coded::Coded<crate::r4b::codes::MapContextType>>,
    ...
    #[serde(default, skip_serializing_if = "::fhir_core::PrimVec::is_empty")]
    pub list_mode: ::fhir_core::PrimVec<crate::coded::Coded<crate::r4b::codes::MapTargetListMode>>,
    /// Primitive extension sibling for [`list_mode`](Self::list_mode) (FHIR `_listMode`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_listMode")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    ...
    /// create | copy +
    pub transform: Option<crate::coded::Coded<crate::r4b::codes::MapTransform>>,
...
///
/// ```
/// use fhir::r4b::resources::structure_map::StructureMapGroupRuleTargetParameter;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::structure_map::StructureMapStructure;
/// use fhir::r4b::types;
///
...
pub struct StructureMapStructure {
    ...
    pub mode: crate::coded::Coded<crate::r4b::codes::MapModelMode>,
    /// Primitive extension sibling for [`mode`](Self::mode) (FHIR `_mode`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_mode")]
    pub mode_ext: Option<types::Element>,
