...
///
/// ```
/// use fhir::r4b::resources::location::Location;
/// use fhir::r4b::types;
///
/// let value = Location {
...
pub struct Location {
    ...
    pub status: Option<crate::coded::Coded<crate::r4b::codes::LocationStatus>>,
    ...
    /// instance | kind
    pub mode: Option<crate::coded::Coded<crate::r4b::codes::LocationMode>>,
    ...
    pub part_of: Option<types::Reference<crate::r4b::resources::Location>>,
...
///
/// ```
/// use fhir::r4b::resources::location::LocationHoursOfOperation;
/// use fhir::r4b::types;
///
...
pub struct LocationHoursOfOperation {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub days_of_week: Vec<crate::coded::Coded<crate::r4b::codes::DaysOfWeek>>,
...
///
/// ```
/// use fhir::r4b::resources::location::LocationPosition;
/// use fhir::r4b::types;
///
