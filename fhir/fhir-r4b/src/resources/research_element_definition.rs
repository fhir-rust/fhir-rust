...
struct ResearchElementDefinitionDe {
    ...
    #[serde(flatten)]
    subject: crate::r4b::choice::Slot<ResearchElementDefinitionSubject>,
    ...
    r#type: crate::coded::Coded<crate::r4b::codes::ResearchElementType>,
    #[serde(rename = "_type")]
    type_ext: Option<types::Element>,
    variable_type: Option<crate::coded::Coded<crate::r4b::codes::VariableType>>,
    #[serde(rename = "_variableType")]
...
struct ResearchElementDefinitionCharacteristicDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    definition: crate::r4b::choice::Slot<ResearchElementDefinitionCharacteristicDefinition>,
    #[serde(default)]
    ...
    #[serde(flatten)]
    study_effective:
        crate::r4b::choice::Slot<ResearchElementDefinitionCharacteristicStudyEffective>,
    study_effective_time_from_start: Option<types::Duration>,
    study_effective_group_measure: Option<crate::coded::Coded<crate::r4b::codes::GroupMeasure>>,
    #[serde(rename = "_studyEffectiveGroupMeasure")]
    ...
    participant_effective:
        crate::r4b::choice::Slot<ResearchElementDefinitionCharacteristicParticipantEffective>,
