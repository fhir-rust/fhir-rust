...
///
/// ```
/// use fhir::r4b::resources::molecular_sequence::MolecularSequence;
/// use fhir::r4b::types;
///
...
pub struct MolecularSequence {
    ...
    /// aa | dna | rna
    pub r#type: Option<crate::coded::Coded<crate::r4b::codes::SequenceType>>,
    ...
    pub specimen: Option<types::Reference<crate::r4b::resources::Specimen>>,

    /// The method for sequencing
    pub device: Option<types::Reference<crate::r4b::resources::Device>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub pointer: Vec<types::Reference<crate::r4b::resources::MolecularSequence>>,
...
///
/// ```
/// use fhir::r4b::resources::molecular_sequence::MolecularSequenceQuality;
/// use fhir::r4b::types;
///
...
pub struct MolecularSequenceQuality {
    ...
    /// indel | snp | unknown
    pub r#type: crate::coded::Coded<crate::r4b::codes::QualityType>,
    /// Primitive extension sibling for [`r#type`](Self::r#type) (FHIR `_type`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_type")]
    pub type_ext: Option<types::Element>,
...
///
/// ```
/// use fhir::r4b::resources::molecular_sequence::MolecularSequenceQualityRoc;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::molecular_sequence::MolecularSequenceReferenceSeq;
/// use fhir::r4b::types;
///
...
pub struct MolecularSequenceReferenceSeq {
    ...
    /// sense | antisense
    pub orientation: Option<crate::coded::Coded<crate::r4b::codes::OrientationType>>,
    ...
    pub reference_seq_pointer: Option<types::Reference<crate::r4b::resources::MolecularSequence>>,
    ...
    /// watson | crick
    pub strand: Option<crate::coded::Coded<crate::r4b::codes::StrandType>>,
...
///
/// ```
/// use fhir::r4b::resources::molecular_sequence::MolecularSequenceRepository;
/// use fhir::r4b::types;
///
...
pub struct MolecularSequenceRepository {
    ...
    pub r#type: crate::coded::Coded<crate::r4b::codes::RepositoryType>,
    /// Primitive extension sibling for [`r#type`](Self::r#type) (FHIR `_type`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_type")]
    pub type_ext: Option<types::Element>,
...
///
/// ```
/// use fhir::r4b::resources::molecular_sequence::MolecularSequenceStructureVariant;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::molecular_sequence::MolecularSequenceStructureVariantInner;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::molecular_sequence::MolecularSequenceStructureVariantOuter;
/// use fhir::r4b::types;
///
...
///
/// ```
/// use fhir::r4b::resources::molecular_sequence::MolecularSequenceVariant;
/// use fhir::r4b::types;
///
...
pub struct MolecularSequenceVariant {
    ...
    pub variant_pointer: Option<types::Reference<crate::r4b::resources::Observation>>,
}
