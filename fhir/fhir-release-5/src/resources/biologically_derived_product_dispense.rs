...
pub struct BiologicallyDerivedProductDispense {
    ...
    /// Short description
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub part_of: Vec<types::Reference<crate::r5::resources::BiologicallyDerivedProductDispense>>,
    ...
    pub product: types::Reference<crate::r5::resources::BiologicallyDerivedProduct>,
...
pub struct BiologicallyDerivedProductDispensePerformer {
    ...
    pub actor: types::Reference<crate::r5::resources::Practitioner>,
}
