...
//! in [`::fhir_core::client`]; this module pins it to R3.
//!
//! ```no_run
...
pub type Client = ::fhir_core::client::ReleaseClient<super::R3>;

/// An error from a FHIR R3 REST interaction.
pub type ClientError = ::fhir_core::client::ReleaseClientError<super::R3>;
