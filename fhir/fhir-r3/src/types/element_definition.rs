...
pub struct ElementDefinition {
    ...
    pub representation:
        ::fhir_core::PrimVec<crate::coded::Coded<crate::r3::codes::PropertyRepresentation>>,
...
struct ElementDefinitionDe {
    ...
    #[serde(flatten)]
    default_value: crate::r3::choice::Slot<ElementDefinitionDefaultValue>,
    ...
    #[serde(flatten)]
    fixed: crate::r3::choice::Slot<ElementDefinitionFixed>,
    #[serde(flatten)]
    pattern: crate::r3::choice::Slot<ElementDefinitionPattern>,
    #[serde(default)]
    example: Vec<ElementDefinitionExample>,
    #[serde(flatten)]
    min_value: crate::r3::choice::Slot<ElementDefinitionMinValue>,
    #[serde(flatten)]
    max_value: crate::r3::choice::Slot<ElementDefinitionMaxValue>,
...
struct ElementDefinitionBindingDe {
    ...
    #[serde(flatten)]
    value_set: crate::r3::choice::Slot<ElementDefinitionBindingValueSet>,
}
...
struct ElementDefinitionExampleDe {
    ...
    label_ext: Option<types::Element>,
    #[serde(flatten)]
    value: crate::r3::choice::Slot<ElementDefinitionExampleValue>,
}
...
///     target_profile: Some(types::Uri("http://example.org".to_string())),
///     ..Default::default()
/// };
/// let json = ::serde_json::to_value(&value).unwrap();
/// // `targetProfile` is the name this serializes to on the wire.
/// assert_eq!(json["targetProfile"], ::serde_json::json!("http://example.org"));
///
...
pub struct ElementDefinitionType {
    ...
    #[serde(default, skip_serializing_if = "::fhir_core::PrimVec::is_empty")]
    pub aggregation:
        ::fhir_core::PrimVec<crate::coded::Coded<crate::r3::codes::ResourceAggregationMode>>,
