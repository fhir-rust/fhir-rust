...
struct RiskAssessmentDe {
    ...
    #[serde(flatten)]
    occurrence: crate::r3::choice::Slot<RiskAssessmentOccurrence>,
    condition: Option<types::Reference<crate::r3::resources::Condition>>,
    performer: Option<types::Reference>,
    #[serde(flatten)]
    reason: crate::r3::choice::Slot<RiskAssessmentReason>,
    #[serde(default)]
...
struct RiskAssessmentPredictionDe {
    ...
    #[serde(flatten)]
    probability: crate::r3::choice::Slot<RiskAssessmentPredictionProbability>,
    qualitative_risk: Option<types::CodeableConcept>,
    relative_risk: Option<types::Decimal>,
    #[serde(rename = "_relativeRisk")]
    relative_risk_ext: Option<types::Element>,
    #[serde(flatten)]
    when: crate::r3::choice::Slot<RiskAssessmentPredictionWhen>,
