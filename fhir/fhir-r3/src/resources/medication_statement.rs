...
struct MedicationStatementDe {
    ...
    status: crate::coded::Coded<crate::r3::codes::MedicationStatementStatus>,
    #[serde(rename = "_status")]
    status_ext: Option<types::Element>,
    category: Option<types::CodeableConcept>,
    #[serde(flatten)]
    medication: crate::r3::choice::Slot<MedicationStatementMedication>,
    #[serde(flatten)]
    effective: crate::r3::choice::Slot<MedicationStatementEffective>,
    ...
    taken: crate::coded::Coded<crate::r3::codes::MedicationStatementTaken>,
    #[serde(rename = "_taken")]
    taken_ext: Option<types::Element>,
    #[serde(default)]
