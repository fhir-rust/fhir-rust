...
pub struct PractitionerRole {
    ...
    /// organation
    pub practitioner: Option<types::Reference<crate::r3::resources::Practitioner>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub healthcare_service: Vec<types::Reference<crate::r3::resources::HealthcareService>>,
