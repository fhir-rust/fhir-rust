...
pub struct ChargeItem {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub part_of: Vec<types::Reference<crate::r3::resources::ChargeItem>>,
    ...
    pub performing_organization: Option<types::Reference<crate::r3::resources::Organization>>,

    /// Organization requesting the charged service
    pub requesting_organization: Option<types::Reference<crate::r3::resources::Organization>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub account: Vec<types::Reference<crate::r3::resources::Account>>,
...
struct ChargeItemDe {
    ...
    status: crate::coded::Coded<crate::r3::codes::ChargeitemStatus>,
    #[serde(rename = "_status")]
    status_ext: Option<types::Element>,
    #[serde(default)]
    part_of: Vec<types::Reference<crate::r3::resources::ChargeItem>>,
    code: types::CodeableConcept,
    subject: types::Reference,
    context: Option<types::Reference>,
    #[serde(flatten)]
    occurrence: crate::r3::choice::Slot<ChargeItemOccurrence>,
    #[serde(default)]
    participant: Vec<ChargeItemParticipant>,
    performing_organization: Option<types::Reference<crate::r3::resources::Organization>>,
    requesting_organization: Option<types::Reference<crate::r3::resources::Organization>>,
    ...
    #[serde(default)]
    account: Vec<types::Reference<crate::r3::resources::Account>>,
    #[serde(default)]
