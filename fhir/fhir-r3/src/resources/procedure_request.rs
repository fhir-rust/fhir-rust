...
struct ProcedureRequestDe {
    ...
    #[serde(flatten)]
    occurrence: crate::r3::choice::Slot<ProcedureRequestOccurrence>,
    #[serde(flatten)]
    as_needed: crate::r3::choice::Slot<ProcedureRequestAsNeeded>,
    authored_on: Option<types::DateTime>,
    #[serde(rename = "_authoredOn")]
    authored_on_ext: Option<types::Element>,
    requester: Option<ProcedureRequestRequester>,
