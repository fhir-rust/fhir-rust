...
struct PatientDe {
    ...
    #[serde(flatten)]
    deceased: crate::r3::choice::Slot<PatientDeceased>,
    #[serde(default)]
    address: Vec<types::Address>,
    marital_status: Option<types::CodeableConcept>,
    #[serde(flatten)]
    multiple_birth: crate::r3::choice::Slot<PatientMultipleBirth>,
    #[serde(default)]
    ...
    managing_organization: Option<types::Reference<crate::r3::resources::Organization>>,
    #[serde(default)]
