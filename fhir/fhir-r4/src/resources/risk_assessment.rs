...
pub struct RiskAssessment {
    ...
    /// Condition assessed
    pub condition: Option<types::Reference<crate::r4::resources::Condition>>,
...
struct RiskAssessmentDe {
    ...
    status: crate::coded::Coded<crate::r4::codes::ObservationStatus>,
    #[serde(rename = "_status")]
    ...
    #[serde(flatten)]
    occurrence: crate::r4::choice::Slot<RiskAssessmentOccurrence>,
    condition: Option<types::Reference<crate::r4::resources::Condition>>,
...
struct RiskAssessmentPredictionDe {
    ...
    #[serde(flatten)]
    probability: crate::r4::choice::Slot<RiskAssessmentPredictionProbability>,
    qualitative_risk: Option<types::CodeableConcept>,
    relative_risk: Option<types::Decimal>,
    #[serde(rename = "_relativeRisk")]
    relative_risk_ext: Option<types::Element>,
    #[serde(flatten)]
    when: crate::r4::choice::Slot<RiskAssessmentPredictionWhen>,
