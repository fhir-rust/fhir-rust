...
struct ImmunizationRecommendationRecommendationDe {
    ...
    #[serde(flatten)]
    dose_number: crate::r4::choice::Slot<ImmunizationRecommendationRecommendationDoseNumber>,
    #[serde(flatten)]
    series_doses: crate::r4::choice::Slot<ImmunizationRecommendationRecommendationSeriesDoses>,
    #[serde(default)]
