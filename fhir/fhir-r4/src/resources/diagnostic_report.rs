...
struct DiagnosticReportDe {
    ...
    status: crate::coded::Coded<crate::r4::codes::DiagnosticReportStatus>,
    #[serde(rename = "_status")]
    ...
    #[serde(flatten)]
    effective: crate::r4::choice::Slot<DiagnosticReportEffective>,
    ...
    #[serde(default)]
    result: Vec<types::Reference<crate::r4::resources::Observation>>,
    #[serde(default)]
    imaging_study: Vec<types::Reference<crate::r4::resources::ImagingStudy>>,
    #[serde(default)]
