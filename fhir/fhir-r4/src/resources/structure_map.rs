...
struct StructureMapGroupRuleSourceDe {
    ...
    #[serde(flatten)]
    default_value: crate::r4::choice::Slot<StructureMapGroupRuleSourceDefaultValue>,
    element: Option<types::String>,
    #[serde(rename = "_element")]
    element_ext: Option<types::Element>,
    list_mode: Option<crate::coded::Coded<crate::r4::codes::MapSourceListMode>>,
    #[serde(rename = "_listMode")]
...
pub struct StructureMapGroupRuleTarget {
    ...
    #[serde(default, skip_serializing_if = "::fhir_core::PrimVec::is_empty")]
    pub list_mode: ::fhir_core::PrimVec<crate::coded::Coded<crate::r4::codes::MapTargetListMode>>,
    /// Primitive extension sibling for [`list_mode`](Self::list_mode) (FHIR `_listMode`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_listMode")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
...
struct StructureMapGroupRuleTargetParameterDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    value: crate::r4::choice::Slot<StructureMapGroupRuleTargetParameterValue>,
}
