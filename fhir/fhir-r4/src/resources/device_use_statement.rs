...
struct DeviceUseStatementDe {
    ...
    #[serde(default)]
    based_on: Vec<types::Reference<crate::r4::resources::ServiceRequest>>,
    status: crate::coded::Coded<crate::r4::codes::DeviceStatementStatus>,
    #[serde(rename = "_status")]
    ...
    #[serde(flatten)]
    timing: crate::r4::choice::Slot<DeviceUseStatementTiming>,
    recorded_on: Option<types::DateTime>,
    #[serde(rename = "_recordedOn")]
    recorded_on_ext: Option<types::Element>,
    source: Option<types::Reference>,
    device: types::Reference<crate::r4::resources::Device>,
    #[serde(default)]
