...
struct BiologicallyDerivedProductCollectionDe {
    ...
    #[serde(flatten)]
    collected: crate::r4::choice::Slot<BiologicallyDerivedProductCollectionCollected>,
}
...
struct BiologicallyDerivedProductManipulationDe {
    ...
    #[serde(flatten)]
    time: crate::r4::choice::Slot<BiologicallyDerivedProductManipulationTime>,
}
...
struct BiologicallyDerivedProductProcessingDe {
    ...
    additive: Option<types::Reference<crate::r4::resources::Substance>>,
    #[serde(flatten)]
    time: crate::r4::choice::Slot<BiologicallyDerivedProductProcessingTime>,
}
