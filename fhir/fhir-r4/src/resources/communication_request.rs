...
struct CommunicationRequestDe {
    ...
    #[serde(default)]
    replaces: Vec<types::Reference<crate::r4::resources::CommunicationRequest>>,
    ...
    #[serde(flatten)]
    occurrence: crate::r4::choice::Slot<CommunicationRequestOccurrence>,
...
struct CommunicationRequestPayloadDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    content: crate::r4::choice::Slot<CommunicationRequestPayloadContent>,
}
