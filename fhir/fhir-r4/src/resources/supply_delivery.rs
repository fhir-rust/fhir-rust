...
pub struct SupplyDelivery {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub based_on: Vec<types::Reference<crate::r4::resources::SupplyRequest>>,
...
struct SupplyDeliveryDe {
    ...
    #[serde(default)]
    based_on: Vec<types::Reference<crate::r4::resources::SupplyRequest>>,
    #[serde(default)]
    part_of: Vec<types::Reference>,
    status: Option<crate::coded::Coded<crate::r4::codes::SupplydeliveryStatus>>,
    #[serde(rename = "_status")]
    ...
    #[serde(flatten)]
    occurrence: crate::r4::choice::Slot<SupplyDeliveryOccurrence>,
...
struct SupplyDeliverySuppliedItemDe {
    ...
    #[serde(flatten)]
    item: crate::r4::choice::Slot<SupplyDeliverySuppliedItemItem>,
}
