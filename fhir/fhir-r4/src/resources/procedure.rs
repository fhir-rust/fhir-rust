...
pub struct Procedure {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub complication_detail: Vec<types::Reference<crate::r4::resources::Condition>>,
...
struct ProcedureDe {
    ...
    status: crate::coded::Coded<crate::r4::codes::EventStatus>,
    #[serde(rename = "_status")]
    ...
    #[serde(flatten)]
    performed: crate::r4::choice::Slot<ProcedurePerformed>,
    ...
    #[serde(default)]
    complication_detail: Vec<types::Reference<crate::r4::resources::Condition>>,
    #[serde(default)]
...
pub struct ProcedureFocalDevice {
    ...
    pub manipulated: types::Reference<crate::r4::resources::Device>,
}
