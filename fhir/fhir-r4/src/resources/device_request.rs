...
struct DeviceRequestDe {
    ...
    status: Option<crate::coded::Coded<crate::r4::codes::RequestStatus>>,
    #[serde(rename = "_status")]
...
struct DeviceRequestParameterDe {
    ...
    #[serde(flatten)]
    value: crate::r4::choice::Slot<DeviceRequestParameterValue>,
}
