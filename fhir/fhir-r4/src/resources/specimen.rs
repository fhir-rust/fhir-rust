...
pub struct Specimen {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub parent: Vec<types::Reference<crate::r4::resources::Specimen>>,
...
struct SpecimenCollectionDe {
    ...
    #[serde(flatten)]
    collected: crate::r4::choice::Slot<SpecimenCollectionCollected>,
    ...
    #[serde(flatten)]
    fasting_status: crate::r4::choice::Slot<SpecimenCollectionFastingStatus>,
}
...
struct SpecimenContainerDe {
    ...
    #[serde(flatten)]
    additive: crate::r4::choice::Slot<SpecimenContainerAdditive>,
}
...
pub struct SpecimenProcessing {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub additive: Vec<types::Reference<crate::r4::resources::Substance>>,
...
struct SpecimenProcessingDe {
    ...
    #[serde(default)]
    additive: Vec<types::Reference<crate::r4::resources::Substance>>,
    #[serde(flatten)]
    time: crate::r4::choice::Slot<SpecimenProcessingTime>,
}
