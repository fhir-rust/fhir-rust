...
pub struct CarePlan {
    ...
    /// Fulfills CarePlan
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub based_on: Vec<types::Reference<crate::r4::resources::CarePlan>>,

    /// CarePlan replaced by this CarePlan
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub replaces: Vec<types::Reference<crate::r4::resources::CarePlan>>,

    /// Part of referenced CarePlan
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub part_of: Vec<types::Reference<crate::r4::resources::CarePlan>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub care_team: Vec<types::Reference<crate::r4::resources::CareTeam>>,

    /// Health issues this plan addresses
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub addresses: Vec<types::Reference<crate::r4::resources::Condition>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub goal: Vec<types::Reference<crate::r4::resources::Goal>>,
...
struct CarePlanActivityDetailDe {
    ...
    #[serde(default)]
    goal: Vec<types::Reference<crate::r4::resources::Goal>>,
    status: crate::coded::Coded<crate::r4::codes::CarePlanActivityStatus>,
    #[serde(rename = "_status")]
    ...
    #[serde(flatten)]
    scheduled: crate::r4::choice::Slot<CarePlanActivityDetailScheduled>,
    location: Option<types::Reference<crate::r4::resources::Location>>,
    #[serde(default)]
    performer: Vec<types::Reference>,
    #[serde(flatten)]
    product: crate::r4::choice::Slot<CarePlanActivityDetailProduct>,
