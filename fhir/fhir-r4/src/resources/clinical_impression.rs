...
pub struct ClinicalImpression {
    ...
    pub previous: Option<types::Reference<crate::r4::resources::ClinicalImpression>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub prognosis_reference: Vec<types::Reference<crate::r4::resources::RiskAssessment>>,
...
struct ClinicalImpressionDe {
    ...
    #[serde(flatten)]
    effective: crate::r4::choice::Slot<ClinicalImpressionEffective>,
    date: Option<types::DateTime>,
    #[serde(rename = "_date")]
    date_ext: Option<types::Element>,
    assessor: Option<types::Reference>,
    previous: Option<types::Reference<crate::r4::resources::ClinicalImpression>>,
    #[serde(default)]
    ...
    #[serde(default)]
    prognosis_reference: Vec<types::Reference<crate::r4::resources::RiskAssessment>>,
    #[serde(default)]
