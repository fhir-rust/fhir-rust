...
struct MedicationAdministrationDe {
    ...
    status: crate::coded::Coded<crate::r4::codes::MedicationAdminStatus>,
    #[serde(rename = "_status")]
    ...
    #[serde(flatten)]
    medication: crate::r4::choice::Slot<MedicationAdministrationMedication>,
    subject: types::Reference,
    context: Option<types::Reference>,
    #[serde(default)]
    supporting_information: Vec<types::Reference>,
    #[serde(flatten)]
    effective: crate::r4::choice::Slot<MedicationAdministrationEffective>,
    #[serde(default)]
    ...
    request: Option<types::Reference<crate::r4::resources::MedicationRequest>>,
    #[serde(default)]
    device: Vec<types::Reference<crate::r4::resources::Device>>,
    #[serde(default)]
...
struct MedicationAdministrationDosageDe {
    ...
    #[serde(flatten)]
    rate: crate::r4::choice::Slot<MedicationAdministrationDosageRate>,
}
