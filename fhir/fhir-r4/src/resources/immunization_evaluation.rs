...
struct ImmunizationEvaluationDe {
    ...
    immunization_event: types::Reference<crate::r4::resources::Immunization>,
    ...
    #[serde(flatten)]
    dose_number: crate::r4::choice::Slot<ImmunizationEvaluationDoseNumber>,
    #[serde(flatten)]
    series_doses: crate::r4::choice::Slot<ImmunizationEvaluationSeriesDoses>,
}
