...
struct GoalDe {
    ...
    lifecycle_status: crate::coded::Coded<crate::r4::codes::GoalStatus>,
    #[serde(rename = "_lifecycleStatus")]
    ...
    #[serde(flatten)]
    start: crate::r4::choice::Slot<GoalStart>,
    #[serde(default)]
    ...
    #[serde(default)]
    outcome_reference: Vec<types::Reference<crate::r4::resources::Observation>>,
}
...
struct GoalTargetDe {
    ...
    #[serde(flatten)]
    detail: crate::r4::choice::Slot<GoalTargetDetail>,
    #[serde(flatten)]
    due: crate::r4::choice::Slot<GoalTargetDue>,
}
