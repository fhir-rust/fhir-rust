...
pub struct CoverageEligibilityResponse {
    ...
    pub request: types::Reference<crate::r4::resources::CoverageEligibilityRequest>,
...
struct CoverageEligibilityResponseDe {
    ...
    purpose: ::vec1::Vec1<crate::coded::Coded<crate::r4::codes::EligibilityresponsePurpose>>,
    #[serde(rename = "_purpose")]
    #[serde(default)]
    purpose_ext: Vec<Option<types::Element>>,
    patient: types::Reference<crate::r4::resources::Patient>,
    #[serde(flatten)]
    serviced: crate::r4::choice::Slot<CoverageEligibilityResponseServiced>,
    created: types::DateTime,
    #[serde(rename = "_created")]
    created_ext: Option<types::Element>,
    requestor: Option<types::Reference>,
    request: types::Reference<crate::r4::resources::CoverageEligibilityRequest>,
    outcome: crate::coded::Coded<crate::r4::codes::RemittanceOutcome>,
    #[serde(rename = "_outcome")]
...
struct CoverageEligibilityResponseInsuranceItemBenefitDe {
    ...
    #[serde(flatten)]
    allowed: crate::r4::choice::Slot<CoverageEligibilityResponseInsuranceItemBenefitAllowed>,
    #[serde(flatten)]
    used: crate::r4::choice::Slot<CoverageEligibilityResponseInsuranceItemBenefitUsed>,
}
