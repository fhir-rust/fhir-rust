...
///
/// ```ignore
/// use fhir::r6::resources::capability_statement::CapabilityStatement;
///
...
pub struct CapabilityStatement {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub actor_definition_ext: Vec<Option<types::Element>>,
    ...
    pub fhir_version: crate::coded::Coded<crate::r6::codes::FhirVersion>,
...
struct CapabilityStatementDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r6::choice::Slot<CapabilityStatementVersionAlgorithm>,
    ...
    fhir_version: crate::coded::Coded<crate::r6::codes::FhirVersion>,
    #[serde(rename = "_fhirVersion")]
...
impl ::core::convert::From<CapabilityStatementDe> for CapabilityStatement {
    fn from(v: CapabilityStatementDe) -> Self {
        Self {
            ...
            actor_definition: v.actor_definition,
            actor_definition_ext: v.actor_definition_ext,
...
///
/// ```
/// use fhir::r6::resources::capability_statement::CapabilityStatementDocument;
/// use fhir::r6::types;
///
...
pub struct CapabilityStatementDocument {
    ...
    /// producer | consumer
    pub mode: crate::coded::Coded<crate::r6::codes::DocumentMode>,
...
///
/// ```
/// use fhir::r6::resources::capability_statement::CapabilityStatementImplementation;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::capability_statement::CapabilityStatementMessaging;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::capability_statement::CapabilityStatementMessagingEndpoint;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::capability_statement::CapabilityStatementMessagingSupportedMessage;
/// use fhir::r6::types;
///
...
pub struct CapabilityStatementMessagingSupportedMessage {
    ...
    /// sender | receiver
    pub mode: crate::coded::Coded<crate::r6::codes::EventCapabilityMode>,
    /// Primitive extension sibling for [`mode`](Self::mode) (FHIR `_mode`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_mode")]
    pub mode_ext: Option<types::Element>,
...
///
/// ```
/// use fhir::r6::resources::capability_statement::CapabilityStatementRest;
/// use fhir::r6::types;
///
...
pub struct CapabilityStatementRest {
    ...
    /// client | server
    pub mode: crate::coded::Coded<crate::r6::codes::RestfulCapabilityMode>,
    /// Primitive extension sibling for [`mode`](Self::mode) (FHIR `_mode`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_mode")]
    pub mode_ext: Option<types::Element>,
...
///
/// ```
/// use fhir::r6::resources::capability_statement::CapabilityStatementRestInteraction;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::capability_statement::CapabilityStatementRestResource;
/// use fhir::r6::types;
///
...
pub struct CapabilityStatementRestResource {
    ...
    pub versioning: Option<crate::coded::Coded<crate::r6::codes::VersioningPolicy>>,
    ...
    pub conditional_read: Option<crate::coded::Coded<crate::r6::codes::ConditionalReadStatus>>,
    ...
    pub conditional_delete: Option<crate::coded::Coded<crate::r6::codes::ConditionalDeleteStatus>>,
...
///
/// ```
/// use fhir::r6::resources::capability_statement::CapabilityStatementRestResourceInteraction;
/// use fhir::r6::types;
///
...
pub struct CapabilityStatementRestResourceInteraction {
    ...
    /// delete-history | delete-history-version | history-instance |
    /// history-type | create | create-conditional | search-type
    pub code: types::Code,
    /// Primitive extension sibling for [`code`](Self::code) (FHIR `_code`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_code")]
...
///
/// ```
/// use fhir::r6::resources::capability_statement::CapabilityStatementRestResourceOperation;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::capability_statement::CapabilityStatementRestResourceSearchParam;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::capability_statement::CapabilityStatementRestSecurity;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::capability_statement::CapabilityStatementSoftware;
/// use fhir::r6::types;
///
