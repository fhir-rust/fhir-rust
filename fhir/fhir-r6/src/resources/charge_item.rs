...
pub struct ChargeItem {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub part_of: Vec<types::Reference<crate::r6::resources::ChargeItem>>,
    ...
    pub performing_organization: Option<types::Reference<crate::r6::resources::Organization>>,

    /// Organization requesting the charged service
    pub requesting_organization: Option<types::Reference<crate::r6::resources::Organization>>,

    /// Organization that has ownership of the (potential, future) revenue
    pub cost_center: Option<types::Reference<crate::r6::resources::Organization>>,
...
struct ChargeItemDe {
    ...
    status: crate::coded::Coded<crate::r6::codes::ChargeitemStatus>,
    #[serde(rename = "_status")]
    status_ext: Option<types::Element>,
    #[serde(default)]
    part_of: Vec<types::Reference<crate::r6::resources::ChargeItem>>,
    code: types::CodeableConcept,
    subject: types::Reference,
    encounter: Option<types::Reference<crate::r6::resources::Encounter>>,
    #[serde(flatten)]
    occurrence: crate::r6::choice::Slot<ChargeItemOccurrence>,
    #[serde(default)]
    performer: Vec<ChargeItemPerformer>,
    performing_organization: Option<types::Reference<crate::r6::resources::Organization>>,
    requesting_organization: Option<types::Reference<crate::r6::resources::Organization>>,
    cost_center: Option<types::Reference<crate::r6::resources::Organization>>,
