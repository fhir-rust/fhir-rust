...
/// the information in this resource is specific to the inclusion of the item
/// in the formulary and is not inherent to the item itself.
///
/// # Examples
///
/// ```
/// use fhir::r6::resources::formulary_item::FormularyItem;
/// use fhir::r6::types;
///
...
pub struct FormularyItem {
    ...
    pub status: Option<crate::coded::Coded<crate::r6::codes::FormularyitemStatus>>,
