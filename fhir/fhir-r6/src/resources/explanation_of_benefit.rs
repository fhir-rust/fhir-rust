...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefit;
/// use fhir::r6::types;
///
...
pub struct ExplanationOfBenefit {
    ...
    pub status: crate::coded::Coded<crate::r6::codes::ExplanationofbenefitStatus>,
    ...
    pub original_prescription: Option<types::Reference<crate::r6::resources::MedicationRequest>>,
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitAccident;
/// use fhir::r6::types;
///
...
struct ExplanationOfBenefitAccidentDe {
    ...
    #[serde(flatten)]
    location: crate::r6::choice::Slot<ExplanationOfBenefitAccidentLocation>,
}
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitAddItem;
/// use fhir::r6::types;
///
...
struct ExplanationOfBenefitAddItemDe {
    ...
    #[serde(flatten)]
    serviced: crate::r6::choice::Slot<ExplanationOfBenefitAddItemServiced>,
    #[serde(flatten)]
    location: crate::r6::choice::Slot<ExplanationOfBenefitAddItemLocation>,
    patient_paid: Option<types::Money>,
    ...
    #[serde(default)]
    body_site: Vec<ExplanationOfBenefitAddItemBodySite>,
    #[serde(default)]
...
///
/// ```ignore
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitAddItemBodySite;
///
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitAddItemDetail;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitAddItemDetailSubDetail;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitBenefitBalance;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitBenefitBalanceFinancial;
/// use fhir::r6::types;
///
...
struct ExplanationOfBenefitBenefitBalanceFinancialDe {
    ...
    #[serde(flatten)]
    allowed: crate::r6::choice::Slot<ExplanationOfBenefitBenefitBalanceFinancialAllowed>,
    #[serde(flatten)]
    used: crate::r6::choice::Slot<ExplanationOfBenefitBenefitBalanceFinancialUsed>,
}
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitCareTeam;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitDiagnosis;
/// use fhir::r6::types;
///
...
struct ExplanationOfBenefitDiagnosisDe {
    ...
    #[serde(flatten)]
    diagnosis: crate::r6::choice::Slot<ExplanationOfBenefitDiagnosisDiagnosis>,
    #[serde(default)]
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitEvent;
/// use fhir::r6::types;
///
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, PartialEq, Eq, Validate)]
#[serde(rename_all = "camelCase")]
#[serde(from = "ExplanationOfBenefitEventDe")]
#[fhir_version("r6")]
pub struct ExplanationOfBenefitEvent {
    ...
    /// The `ExplanationOfBenefit.event.when[x]` choice element (1..1); see [`ExplanationOfBenefitEventWhen`]. It is `Option` even though the specification makes it mandatory, because a choice enum has no default.
    #[serde(flatten)]
...
#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
struct ExplanationOfBenefitEventDe {
    id: Option<types::String>,
    #[serde(default)]
    extension: Vec<types::Extension>,
    #[serde(default)]
    ...
    r#type: types::CodeableConcept,
    #[serde(flatten)]
    when: crate::r6::choice::Slot<ExplanationOfBenefitEventWhen>,
}

impl ::core::convert::From<ExplanationOfBenefitEventDe> for ExplanationOfBenefitEvent {
    fn from(v: ExplanationOfBenefitEventDe) -> Self {
        Self {
            id: v.id,
            extension: v.extension,
            modifier_extension: v.modifier_extension,
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitInsurance;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitItem;
/// use fhir::r6::types;
///
...
struct ExplanationOfBenefitItemDe {
    ...
    program_code: Vec<types::CodeableConcept>,
    #[serde(flatten)]
    serviced: crate::r6::choice::Slot<ExplanationOfBenefitItemServiced>,
    #[serde(flatten)]
    location: crate::r6::choice::Slot<ExplanationOfBenefitItemLocation>,
    patient_paid: Option<types::Money>,
    quantity: Option<types::Quantity>,
    unit_price: Option<types::Money>,
    factor: Option<types::Decimal>,
    ...
    net: Option<types::Money>,
    #[serde(default)]
    udi: Vec<types::Reference<crate::r6::resources::Device>>,
    #[serde(default)]
    body_site: Vec<ExplanationOfBenefitItemBodySite>,
    #[serde(default)]
    encounter: Vec<types::Reference<crate::r6::resources::Encounter>>,
    #[serde(default)]
    note_number: ::fhir_core::PrimVec<types::PositiveInt>,
    #[serde(rename = "_noteNumber")]
    #[serde(default)]
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitItemAdjudication;
/// use fhir::r6::types;
///
...
///
/// ```ignore
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitItemBodySite;
///
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitItemDetail;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitItemDetailSubDetail;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitItemReviewOutcome;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitPayee;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitPayment;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitProcedure;
/// use fhir::r6::types;
///
...
struct ExplanationOfBenefitProcedureDe {
    ...
    date_ext: Option<types::Element>,
    #[serde(flatten)]
    procedure: crate::r6::choice::Slot<ExplanationOfBenefitProcedureProcedure>,
    #[serde(default)]
    udi: Vec<types::Reference<crate::r6::resources::Device>>,
}
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitProcessNote;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitRelated;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitSupportingInfo;
/// use fhir::r6::types;
///
...
struct ExplanationOfBenefitSupportingInfoDe {
    ...
    #[serde(flatten)]
    timing: crate::r6::choice::Slot<ExplanationOfBenefitSupportingInfoTiming>,
    #[serde(flatten)]
    value: crate::r6::choice::Slot<ExplanationOfBenefitSupportingInfoValue>,
...
///
/// ```
/// use fhir::r6::resources::explanation_of_benefit::ExplanationOfBenefitTotal;
/// use fhir::r6::types;
///
