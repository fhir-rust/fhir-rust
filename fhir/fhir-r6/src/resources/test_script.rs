...
struct TestScriptDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r6::choice::Slot<TestScriptVersionAlgorithm>,
    name: types::String,
    #[serde(rename = "_name")]
    ...
    #[serde(default)]
    test_system: Vec<TestScriptTestSystem>,
