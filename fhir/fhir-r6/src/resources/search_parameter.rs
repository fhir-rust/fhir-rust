...
struct SearchParameterDe {
    ...
    #[serde(default)]
    comparator: Vec<crate::coded::Coded<crate::r6::codes::SearchComparator>>,
    #[serde(rename = "_comparator")]
    #[serde(default)]
    comparator_ext: Vec<Option<types::Element>>,
    #[serde(default)]
    modifier: Vec<crate::coded::Coded<crate::r6::codes::SearchModifierCode>>,
    #[serde(rename = "_modifier")]
    #[serde(default)]
