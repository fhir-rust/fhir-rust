...
struct ValueSetDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r6::choice::Slot<ValueSetVersionAlgorithm>,
...
struct ValueSetExpansionContainsPropertyDe {
    ...
    #[serde(flatten)]
    value: crate::r6::choice::Slot<ValueSetExpansionContainsPropertyValue>,
    #[serde(default)]
...
struct ValueSetExpansionContainsPropertySubPropertyDe {
    ...
    code_ext: Option<types::Element>,
    #[serde(flatten)]
    value: crate::r6::choice::Slot<ValueSetExpansionContainsPropertySubPropertyValue>,
}
...
struct ValueSetExpansionParameterDe {
    ...
    name_ext: Option<types::Element>,
    #[serde(flatten)]
    value: crate::r6::choice::Slot<ValueSetExpansionParameterValue>,
}
