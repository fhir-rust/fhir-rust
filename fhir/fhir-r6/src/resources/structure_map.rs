...
struct StructureMapDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r6::choice::Slot<StructureMapVersionAlgorithm>,
    name: types::String,
    #[serde(rename = "_name")]
    ...
    #[serde(default)]
    r#const: Vec<StructureMapConst>,
    group: ::vec1::Vec1<StructureMapGroup>,
}

impl ::core::convert::From<StructureMapDe> for StructureMap {
    fn from(v: StructureMapDe) -> Self {
        Self {
            id: v.id,
            meta: v.meta,
...
pub struct StructureMapGroupRuleTarget {
    ...
    #[serde(default, skip_serializing_if = "::fhir_core::PrimVec::is_empty")]
    pub list_mode: ::fhir_core::PrimVec<crate::coded::Coded<crate::r6::codes::MapTargetListMode>>,
    /// Primitive extension sibling for [`list_mode`](Self::list_mode) (FHIR `_listMode`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_listMode")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
...
struct StructureMapGroupRuleTargetParameterDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    value: crate::r6::choice::Slot<StructureMapGroupRuleTargetParameterValue>,
}
