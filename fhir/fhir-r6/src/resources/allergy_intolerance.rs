...
///
/// ```
/// use fhir::r6::resources::allergy_intolerance::AllergyIntolerance;
/// use fhir::r6::types;
///
...
pub struct AllergyIntolerance {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub category: Vec<crate::coded::Coded<crate::r6::codes::AllergyIntoleranceCategory>>,
    ...
    pub criticality: Option<crate::coded::Coded<crate::r6::codes::AllergyIntoleranceCriticality>>,
    ...
    pub last_reaction_occurrence: Option<types::DateTime>,
    /// Primitive extension sibling for [`last_reaction_occurrence`](Self::last_reaction_occurrence) (FHIR `_lastReactionOccurrence`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_lastReactionOccurrence")]
    pub last_reaction_occurrence_ext: Option<types::Element>,
...
struct AllergyIntoleranceDe {
    ...
    #[serde(default)]
    category: Vec<crate::coded::Coded<crate::r6::codes::AllergyIntoleranceCategory>>,
    #[serde(rename = "_category")]
    #[serde(default)]
    category_ext: Vec<Option<types::Element>>,
    criticality: Option<crate::coded::Coded<crate::r6::codes::AllergyIntoleranceCriticality>>,
    #[serde(rename = "_criticality")]
    ...
    #[serde(flatten)]
    onset: crate::r6::choice::Slot<AllergyIntoleranceOnset>,
    ...
    last_reaction_occurrence: Option<types::DateTime>,
    #[serde(rename = "_lastReactionOccurrence")]
    last_reaction_occurrence_ext: Option<types::Element>,
    #[serde(default)]
...
impl ::core::convert::From<AllergyIntoleranceDe> for AllergyIntolerance {
    fn from(v: AllergyIntoleranceDe) -> Self {
        Self {
            ...
            recorder: v.recorder,
            asserter: v.asserter,
            last_reaction_occurrence: v.last_reaction_occurrence,
            last_reaction_occurrence_ext: v.last_reaction_occurrence_ext,
            note: v.note,
            reaction: v.reaction,
        }
    }
...
///
/// ```ignore
/// use fhir::r6::resources::allergy_intolerance::AllergyIntoleranceReaction;
///
...
pub struct AllergyIntoleranceReaction {
    ...
    pub severity: Option<crate::coded::Coded<crate::r6::codes::ReactionEventSeverity>>,
