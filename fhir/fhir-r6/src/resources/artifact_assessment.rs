...
struct ArtifactAssessmentDe {
    ...
    #[serde(flatten)]
    artifact: crate::r6::choice::Slot<ArtifactAssessmentArtifact>,
    #[serde(default)]
    relates_to: Vec<ArtifactAssessmentRelatesTo>,
    ...
    disposition: Option<crate::coded::Coded<crate::r6::codes::ArtifactassessmentDisposition>>,
    #[serde(rename = "_disposition")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, PartialEq, Eq, Validate)]
#[serde(rename_all = "camelCase")]
#[serde(from = "ArtifactAssessmentRelatesToDe")]
#[fhir_version("r6")]
...
#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
struct ArtifactAssessmentRelatesToDe {
    id: Option<types::String>,
    #[serde(default)]
    extension: Vec<types::Extension>,
    #[serde(default)]
    ...
    #[serde(flatten)]
    target: crate::r6::choice::Slot<ArtifactAssessmentRelatesToTarget>,
}

impl ::core::convert::From<ArtifactAssessmentRelatesToDe> for ArtifactAssessmentRelatesTo {
    fn from(v: ArtifactAssessmentRelatesToDe) -> Self {
        Self {
            id: v.id,
            extension: v.extension,
            modifier_extension: v.modifier_extension,
