...
struct GraphDefinitionDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r6::choice::Slot<GraphDefinitionVersionAlgorithm>,
    name: types::String,
    #[serde(rename = "_name")]
    ...
    start: Option<types::Id>,
    #[serde(rename = "_start")]
    start_ext: Option<types::Element>,
    #[serde(default)]
    node: Vec<GraphDefinitionNode>,
    #[serde(default)]
    link: Vec<GraphDefinitionLink>,
}

impl ::core::convert::From<GraphDefinitionDe> for GraphDefinition {
    fn from(v: GraphDefinitionDe) -> Self {
        Self {
            id: v.id,
            meta: v.meta,
