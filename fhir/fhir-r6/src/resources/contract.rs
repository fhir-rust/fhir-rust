...
struct ContractDe {
    ...
    status: Option<crate::coded::Coded<crate::r6::codes::ContractStatus>>,
    #[serde(rename = "_status")]
    status_ext: Option<types::Element>,
    legal_state: Option<types::CodeableConcept>,
    instantiates_canonical: Option<types::Reference<crate::r6::resources::Contract>>,
    ...
    #[serde(default)]
    authority: Vec<types::Reference<crate::r6::resources::Organization>>,
    #[serde(default)]
    domain: Vec<types::Reference<crate::r6::resources::Location>>,
    #[serde(default)]
    site: Vec<types::Reference<crate::r6::resources::Location>>,
    ...
    #[serde(flatten)]
    topic: crate::r6::choice::Slot<ContractTopic>,
    ...
    #[serde(flatten)]
    legally_binding: crate::r6::choice::Slot<ContractLegallyBinding>,
}
...
struct ContractFriendlyDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    content: crate::r6::choice::Slot<ContractFriendlyContent>,
}
...
struct ContractLegalDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    content: crate::r6::choice::Slot<ContractLegalContent>,
}
...
struct ContractRuleDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    content: crate::r6::choice::Slot<ContractRuleContent>,
}
...
struct ContractTermDe {
    ...
    applies: Option<types::Period>,
    #[serde(flatten)]
    topic: crate::r6::choice::Slot<ContractTermTopic>,
    r#type: Option<types::CodeableConcept>,
...
struct ContractTermActionDe {
    ...
    #[serde(flatten)]
    occurrence: crate::r6::choice::Slot<ContractTermActionOccurrence>,
    #[serde(default)]
...
struct ContractTermAssetValuedItemDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    entity: crate::r6::choice::Slot<ContractTermAssetValuedItemEntity>,
    identifier: Option<types::Identifier>,
...
struct ContractTermOfferAnswerDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    value: crate::r6::choice::Slot<ContractTermOfferAnswerValue>,
}
