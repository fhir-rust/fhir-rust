...
///
/// ```
/// use fhir::r6::resources::terminology_capabilities::TerminologyCapabilities;
/// use fhir::r6::types;
///
...
#[serde(from = "TerminologyCapabilitiesDe")]
#[fhir_version("r6")]
pub struct TerminologyCapabilities {
    ...
    pub kind: crate::coded::Coded<crate::r6::codes::CapabilityStatementKind>,
    ...
    pub code_search: Option<crate::coded::Coded<crate::r6::codes::CodeSearchSupport>>,
...
#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
struct TerminologyCapabilitiesDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r6::choice::Slot<TerminologyCapabilitiesVersionAlgorithm>,
    ...
    kind: crate::coded::Coded<crate::r6::codes::CapabilityStatementKind>,
    #[serde(rename = "_kind")]
    ...
    locked_date: Option<types::Boolean>,
    #[serde(rename = "_lockedDate")]
    locked_date_ext: Option<types::Element>,
    #[serde(default)]
    code_system: Vec<TerminologyCapabilitiesCodeSystem>,
    supplements: Option<TerminologyCapabilitiesSupplements>,
    expansion: Option<TerminologyCapabilitiesExpansion>,
    code_search: Option<crate::coded::Coded<crate::r6::codes::CodeSearchSupport>>,
    #[serde(rename = "_codeSearch")]
    code_search_ext: Option<types::Element>,
...
impl ::core::convert::From<TerminologyCapabilitiesDe> for TerminologyCapabilities {
    fn from(v: TerminologyCapabilitiesDe) -> Self {
        Self {
            id: v.id,
            meta: v.meta,
            ...
            locked_date: v.locked_date,
            locked_date_ext: v.locked_date_ext,
            code_system: v.code_system,
            supplements: v.supplements,
            expansion: v.expansion,
            code_search: v.code_search,
            code_search_ext: v.code_search_ext,
            validate_code: v.validate_code,
...
///
/// ```
/// use fhir::r6::resources::terminology_capabilities::TerminologyCapabilitiesClosure;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::terminology_capabilities::TerminologyCapabilitiesCodeSystem;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::terminology_capabilities::TerminologyCapabilitiesCodeSystemVersion;
/// use fhir::r6::types;
///
...
///
/// ```ignore
/// use fhir::r6::resources::terminology_capabilities::TerminologyCapabilitiesCodeSystemVersionFilter;
///
...
///
/// ```
/// use fhir::r6::resources::terminology_capabilities::TerminologyCapabilitiesExpansion;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::terminology_capabilities::TerminologyCapabilitiesExpansionParameter;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::terminology_capabilities::TerminologyCapabilitiesImplementation;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::terminology_capabilities::TerminologyCapabilitiesSoftware;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::terminology_capabilities::TerminologyCapabilitiesSupplements;
/// use fhir::r6::types;
///
/// let value = TerminologyCapabilitiesSupplements {
...
///
/// let back: TerminologyCapabilitiesSupplements = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
#[derive(Debug, Default, Clone, Serialize, Deserialize, PartialEq, Eq, Validate)]
...
pub struct TerminologyCapabilitiesSupplements {
    ...
    pub globals: Option<crate::coded::Coded<crate::r6::codes::GlobalLangpackSupport>>,
    /// Primitive extension sibling for [`globals`](Self::globals) (FHIR `_globals`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_globals")]
    pub globals_ext: Option<types::Element>,
}
...
///
/// ```
/// use fhir::r6::resources::terminology_capabilities::TerminologyCapabilitiesTranslation;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::terminology_capabilities::TerminologyCapabilitiesValidateCode;
/// use fhir::r6::types;
///
