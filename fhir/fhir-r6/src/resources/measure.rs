...
struct MeasureDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r6::choice::Slot<MeasureVersionAlgorithm>,
    ...
    #[serde(flatten)]
    subject: crate::r6::choice::Slot<MeasureSubject>,
    basis: Option<crate::coded::Coded<crate::r6::codes::FhirTypes>>,
    #[serde(rename = "_basis")]
    ...
    reporting_frequency: Option<types::Quantity>,
    #[serde(default)]
    ...
    scoring_precision: Option<types::PositiveInt>,
    #[serde(rename = "_scoringPrecision")]
    scoring_precision_ext: Option<types::Element>,
...
impl ::core::convert::From<MeasureDe> for Measure {
    fn from(v: MeasureDe) -> Self {
        Self {
            ...
            scoring_precision: v.scoring_precision,
            scoring_precision_ext: v.scoring_precision_ext,
...
struct MeasureGroupDe {
    ...
    r#type: Vec<types::CodeableConcept>,
    #[serde(flatten)]
    subject: crate::r6::choice::Slot<MeasureGroupSubject>,
    basis: Option<crate::coded::Coded<crate::r6::codes::FhirTypes>>,
    #[serde(rename = "_basis")]
    basis_ext: Option<types::Element>,
    scoring: Option<types::CodeableConcept>,
    ...
    composite_scoring: Option<types::CodeableConcept>,
    #[serde(default)]
    component: Vec<MeasureGroupComponent>,
    rate_aggregation: Option<types::Markdown>,
    #[serde(rename = "_rateAggregation")]
    rate_aggregation_ext: Option<types::Element>,
    improvement_notation: Option<types::CodeableConcept>,
