...
///
/// ```
/// use fhir::r6::resources::message_header::MessageHeader;
/// use fhir::r6::types;
///
...
struct MessageHeaderDe {
    ...
    #[serde(flatten)]
    event: crate::r6::choice::Slot<MessageHeaderEvent>,
    #[serde(default)]
...
///
/// ```
/// use fhir::r6::resources::message_header::MessageHeaderDestination;
/// use fhir::r6::types;
///
...
struct MessageHeaderDestinationDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    endpoint: crate::r6::choice::Slot<MessageHeaderDestinationEndpoint>,
...
///
/// ```
/// use fhir::r6::resources::message_header::MessageHeaderResponse;
/// use fhir::r6::types;
///
...
pub struct MessageHeaderResponse {
    ...
    pub code: crate::coded::Coded<crate::r6::codes::ResponseCode>,
...
///
/// ```
/// use fhir::r6::resources::message_header::MessageHeaderSource;
/// use fhir::r6::types;
///
...
struct MessageHeaderSourceDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    endpoint: crate::r6::choice::Slot<MessageHeaderSourceEndpoint>,
    name: Option<types::String>,
    #[serde(rename = "_name")]
    name_ext: Option<types::Element>,
