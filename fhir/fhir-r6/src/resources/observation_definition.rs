...
#[serde(from = "ObservationDefinitionDe")]
#[fhir_version("r6")]
...
#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
struct ObservationDefinitionDe {
    ...
    #[serde(flatten)]
    version_algorithm: crate::r6::choice::Slot<ObservationDefinitionVersionAlgorithm>,
    ...
    #[serde(default)]
    subject: Vec<types::CodeableConcept>,
    performer_type: Option<types::CodeableConcept>,
    #[serde(default)]
    category: Vec<types::CodeableConcept>,
    code: types::CodeableConcept,
    #[serde(default)]
    permitted_data_type: Vec<crate::coded::Coded<crate::r6::codes::PermittedDataType>>,
    #[serde(rename = "_permittedDataType")]
    #[serde(default)]
    permitted_data_type_ext: Vec<Option<types::Element>>,
    multiple_results_allowed: Option<types::Boolean>,
    #[serde(rename = "_multipleResultsAllowed")]
    multiple_results_allowed_ext: Option<types::Element>,
    body_site: Option<types::CodeableConcept>,
    method: Option<types::CodeableConcept>,
    #[serde(default)]
    specimen: Vec<types::Reference<crate::r6::resources::SpecimenDefinition>>,
    #[serde(default)]
    device: Vec<types::Reference>,
    preferred_report_name: Option<types::String>,
    #[serde(rename = "_preferredReportName")]
    preferred_report_name_ext: Option<types::Element>,
    #[serde(default)]
    permitted_unit: Vec<types::Coding>,
    #[serde(default)]
    qualified_value: Vec<ObservationDefinitionQualifiedValue>,
    #[serde(default)]
    has_member: Vec<types::Reference>,
    #[serde(default)]
    component: Vec<ObservationDefinitionComponent>,
}

impl ::core::convert::From<ObservationDefinitionDe> for ObservationDefinition {
    fn from(v: ObservationDefinitionDe) -> Self {
        Self {
            id: v.id,
            meta: v.meta,
            ...
            category: v.category,
            code: v.code,
            permitted_data_type: v.permitted_data_type,
            permitted_data_type_ext: v.permitted_data_type_ext,
            multiple_results_allowed: v.multiple_results_allowed,
            multiple_results_allowed_ext: v.multiple_results_allowed_ext,
            body_site: v.body_site,
            method: v.method,
            specimen: v.specimen,
            device: v.device,
            preferred_report_name: v.preferred_report_name,
            preferred_report_name_ext: v.preferred_report_name_ext,
            permitted_unit: v.permitted_unit,
            qualified_value: v.qualified_value,
