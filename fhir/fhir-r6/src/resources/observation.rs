...
struct ObservationDe {
    ...
    #[serde(flatten)]
    instantiates: crate::r6::choice::Slot<ObservationInstantiates>,
    #[serde(default)]
    ...
    organizer: Option<types::Boolean>,
    #[serde(rename = "_organizer")]
    organizer_ext: Option<types::Element>,
    encounter: Option<types::Reference<crate::r6::resources::Encounter>>,
    #[serde(flatten)]
    effective: crate::r6::choice::Slot<ObservationEffective>,
    ...
    #[serde(flatten)]
    value: crate::r6::choice::Slot<ObservationValue>,
...
struct ObservationComponentDe {
    ...
    code: types::CodeableConcept,
    #[serde(flatten)]
    value: crate::r6::choice::Slot<ObservationComponentValue>,
    data_absent_reason: Option<types::CodeableConcept>,
    #[serde(default)]
    interpretation: Vec<types::CodeableConcept>,
    #[serde(default)]
