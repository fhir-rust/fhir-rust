//! Parsing and precision-aware comparison for the FHIR R6 date/time
//! primitives.
//!
...
//! R6 newtypes and re-exports the shared types.
//!
//! ```
//! use fhir::r6::types::Date;
//! use fhir::r6::temporal::DatePrecision;
//!
...
use crate::r6::types::{Date, DateTime, Instant, Time};
