...
///
/// ```
/// use fhir::r6::types::address::Address;
/// use fhir::r6::types;
///
/// let value = Address {
...
pub struct Address {
    ...
    pub r#use: Option<crate::coded::Coded<crate::r6::codes::AddressUse>>,
    ...
    pub r#type: Option<crate::coded::Coded<crate::r6::codes::AddressType>>,
