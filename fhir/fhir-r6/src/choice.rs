...
use crate::r6::types::Element;
use crate::r6::validate::{Validate, ValidationIssue};
...
mod tests {
    use super::*;
    use crate::r6::types::{Boolean, Quantity, String as FhirString};
    ...
    fn validate_runs_on_active_variant() {
        ...
        let invalid = TestValue::Quantity(Box::new(Quantity {
            code: Some(crate::r6::types::Code(String::new())),
            ..Default::default()
        }));
