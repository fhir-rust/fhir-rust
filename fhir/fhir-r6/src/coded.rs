...
//! this crate types them as the matching [`codes`](crate::r6::codes) enum. But
...
//! it is defined once in [`::fhir_core::coded`]; this module re-exports it so R6 code
//! keeps using `fhir::r6::coded::Coded`.
//!
//! ```
