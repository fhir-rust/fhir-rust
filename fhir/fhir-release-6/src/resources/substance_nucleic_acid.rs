...
///
/// ```
/// use fhir::r6::resources::substance_nucleic_acid::SubstanceNucleicAcid;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::substance_nucleic_acid::SubstanceNucleicAcidSubunit;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::substance_nucleic_acid::SubstanceNucleicAcidSubunitLinkage;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::substance_nucleic_acid::SubstanceNucleicAcidSubunitSugar;
/// use fhir::r6::types;
///
