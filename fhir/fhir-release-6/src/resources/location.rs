...
///
/// ```
/// use fhir::r6::resources::location::Location;
/// use fhir::r6::types;
///
/// let value = Location {
...
pub struct Location {
    ...
    pub status: Option<crate::coded::Coded<crate::r6::codes::LocationStatus>>,
    ...
    /// instance | kind
    pub mode: Option<crate::coded::Coded<crate::r6::codes::LocationMode>>,
    ...
    pub part_of: Option<types::Reference<crate::r6::resources::Location>>,
    ...
    /// exceptions)
    pub hours_of_operation: Option<types::Availability>,
...
///
/// ```
/// use fhir::r6::resources::location::LocationPosition;
/// use fhir::r6::types;
///
