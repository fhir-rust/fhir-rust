...
///
/// ```
/// use fhir::r6::resources::list::List;
/// use fhir::r6::types;
///
/// let value = List {
...
pub struct List {
    ...
    pub status: crate::coded::Coded<crate::r6::codes::ListStatus>,
    ...
    pub mode: crate::coded::Coded<crate::r6::codes::ListMode>,
...
///
/// ```
/// use fhir::r6::resources::list::ListEntry;
/// use fhir::r6::types;
///
/// let value = ListEntry {
