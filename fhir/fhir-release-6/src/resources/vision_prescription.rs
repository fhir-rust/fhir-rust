...
///
/// ```ignore
/// use fhir::r6::resources::vision_prescription::VisionPrescription;
///
...
///
/// ```
/// use fhir::r6::resources::vision_prescription::VisionPrescriptionLensSpecification;
/// use fhir::r6::types;
///
...
pub struct VisionPrescriptionLensSpecification {
    ...
    /// right | left
    pub eye: crate::coded::Coded<crate::r6::codes::VisionEyeCodes>,
...
///
/// ```
/// use fhir::r6::resources::vision_prescription::VisionPrescriptionLensSpecificationPrism;
/// use fhir::r6::types;
///
...
pub struct VisionPrescriptionLensSpecificationPrism {
    ...
    /// up | down | in | out
    pub base: crate::coded::Coded<crate::r6::codes::VisionBaseCodes>,
