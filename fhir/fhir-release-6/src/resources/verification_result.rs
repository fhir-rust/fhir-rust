...
///
/// ```
/// use fhir::r6::resources::verification_result::VerificationResult;
/// use fhir::r6::types;
///
...
pub struct VerificationResult {
    ...
    /// | entered-in-error
    pub status: crate::coded::Coded<crate::r6::codes::VerificationresultStatus>,
...
///
/// ```
/// use fhir::r6::resources::verification_result::VerificationResultAttestation;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::verification_result::VerificationResultPrimarySource;
/// use fhir::r6::types;
///
...
///
/// ```
/// use fhir::r6::resources::verification_result::VerificationResultValidator;
/// use fhir::r6::types;
///
