//! FHIR R6 XML serialization (feature `xml`).
//!
...
//! by release and lives in [`::fhir_core::xml`]; this module binds it to the R6
//! [`meta`](crate::r6::meta) table.
//!
//! ```
//! use fhir::r6::resources::Patient;
//! use fhir::r6::xml::{to_xml, from_xml};
//!
...
mod tests {
    use super::*;
    use crate::r6::resources::{Observation, Patient};
