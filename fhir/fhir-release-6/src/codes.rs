//! FHIR R6 code systems as type-safe Rust enums.
//!
//! Each enum corresponds to a complete FHIR R6 `CodeSystem`. Variants
//! serialize to and from their canonical FHIR code strings via serde renames.
//!
//! # Examples
//!
//! ```
//! use fhir::r6::codes::AdministrativeGender;
//!
...
///
/// System: <http://hl7.org/fhir/actordefinition-actor-type>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum ActordefinitionActorType {
    ...
    Collective,
    /// Care Team
    #[serde(rename = "care-team")]
    CareTeam,
    /// Group
    #[serde(rename = "group")]
    Group,
    /// Healthcare Service
    #[serde(rename = "healthcare-service")]
    HealthcareService,
    /// Organization
    #[serde(rename = "organization")]
    Organization,
...
///
/// System: <http://hl7.org/fhir/artifact-relationship-type>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
/// Biologically Derived Product Property Type Code. This code system
/// http://hl7.org/fhir/biologicallyderived-product-property-type-codes is a
...
///
/// System: <http://hl7.org/fhir/detectedissue-management-code>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum DetectedissueManagementCode {
    ...
    #[serde(rename = "review-suggested")]
    ReviewSuggested,
    /// Potential Risk
    #[serde(rename = "potential-risk")]
    PotentialRisk,
}
...
pub enum DeviceAction {
    /// 129336009
    #[default]
    #[serde(rename = "129336009")]
    N129336009,
    /// 278312000
    #[serde(rename = "278312000")]
    N278312000,
    /// 282089006
    #[serde(rename = "282089006")]
    N282089006,
    /// 129303008
    #[serde(rename = "129303008")]
    N129303008,
}
...
///
/// System: <http://hl7.org/fhir/deviceassociation-relationship>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/eligibility>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum Eligibility {
    /// Veterans
    #[default]
    #[serde(rename = "veterans")]
    Veterans,
    /// Pediatric patients
    #[serde(rename = "pediatric-patients")]
    PediatricPatients,
    /// Existing Patients
    #[serde(rename = "existing-patients")]
    ExistingPatients,
    /// New patients
    #[serde(rename = "new-patients")]
    NewPatients,
    /// Low-income patients
    #[serde(rename = "low-income-patients")]
    LowIncomePatients,
    /// Uninsured patients
    #[serde(rename = "uninsured-patients")]
    UninsuredPatients,
    /// Renal patients
    #[serde(rename = "renal-patients")]
    RenalPatients,
    /// Specialist referral required
    #[serde(rename = "specialist-referral-required")]
    SpecialistReferralRequired,
    /// Assessment required
    #[serde(rename = "assessment-required")]
    AssessmentRequired,
}
...
///
/// System: <http://hl7.org/fhir/evidence-variable-classifier>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum EvidenceVariableClassifier {
    ...
    #[serde(rename = "questionnaire-response")]
    QuestionnaireResponse,
}

/// A rule, such as a format or other expectation, for the data values.
///
/// System: <http://hl7.org/fhir/evidence-variable-constraint>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum EvidenceVariableConstraint {
    /// Alphanumeric Characters Only
    #[default]
    #[serde(rename = "alphanumeric-only")]
    AlphanumericOnly,
    /// Alphanumeric and Space Characters Only
    #[serde(rename = "alphanumeric-space-only")]
    AlphanumericSpaceOnly,
    /// Range Zero to One
    #[serde(rename = "range-zero-to-one")]
    RangeZeroToOne,
}
...
/// patterns.
///
/// System: <http://hl7.org/fhir/evidence-variable-unacceptable-data-handling>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum EvidenceVariableUnacceptableDataHandling {
    /// Set Value to Zero
    #[default]
    #[serde(rename = "set-value-to-zero")]
    SetValueToZero,
    /// Set Value to Null
    #[serde(rename = "set-value-to-null")]
    SetValueToNull,
}
...
pub enum FhirTypes {
    ...
    ClaimResponse,
    /// ClinicalAssessment
    #[serde(rename = "ClinicalAssessment")]
    ClinicalAssessment,
    ...
    MetadataResource,
    /// MolecularDefinition
    #[serde(rename = "MolecularDefinition")]
    MolecularDefinition,
    /// MolecularSequence
...
pub enum FhirVersion {
    ...
    N600,
    /// 6.0.0-ballot1
    #[serde(rename = "6.0.0-ballo1")]
    N600Ballo1,
    /// 6.0.0-ballot2
    #[serde(rename = "6.0.0-ballot2")]
    N600Ballot2,
    /// 6.0.0-ballot3
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum GlobalLangpackSupport {
    /// Not Supported
    #[default]
    #[serde(rename = "not-supported")]
    NotSupported,
    /// Language Packs Supported by request
    #[serde(rename = "explicit")]
    Explicit,
    /// Global Language Packs Supported
...
///
/// System: <http://hl7.org/fhir/goal-accept-status>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/group-code>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum GroupCode {
    /// Patient-List
    #[default]
    ...
    Workplace,
    /// Event Attendee
    #[serde(rename = "event-attendee")]
    EventAttendee,
    /// Exposure Group
    #[serde(rename = "exposure-group")]
    ExposureGroup,
    /// Herd
    #[serde(rename = "herd")]
    Herd,
...
pub enum GroupInvolvement {
    /// Index Case
    #[default]
    #[serde(rename = "index-case")]
    IndexCase,
    /// Primary Exposure
    #[serde(rename = "primary-exposure")]
    PrimaryExposure,
    /// Secondary Exposure
    #[serde(rename = "secondary-exposure")]
    SecondaryExposure,
    /// Primary Contact
    #[serde(rename = "primary-contact")]
    PrimaryContact,
    /// Family Member
    #[serde(rename = "family-member")]
    FamilyMember,
    /// Owner
    #[serde(rename = "owner")]
    Owner,
...
/// This example code system defines codes for common types of measure
/// stratification.
///
...
///
/// System: <http://hl7.org/fhir/CodeSystem/nutritionintake-status-reason>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum NutritionintakeStatusReason {
    /// 397709008
    #[default]
    #[serde(rename = "397709008")]
    N397709008,
    /// Incomplete Data
    #[serde(rename = "1")]
    N1,
    ...
    #[serde(rename = "6")]
    N6,
    /// Patient/subject scheduled for surgery
    #[serde(rename = "7")]
    N7,
...
pub enum ObservationStatus {
    ...
    Registered,
    /// Specimen-in-Process
    #[serde(rename = "specimen-in-process")]
    SpecimenInProcess,
    /// Preliminary
    #[serde(rename = "preliminary")]
    Preliminary,
    ...
    Unknown,
    /// Cannot be obtained
    #[serde(rename = "cannot-be-obtained")]
    CannotBeObtained,
}
...
///
/// System: <http://hl7.org/fhir/patch-operation>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
/// Set of statuses that apply to qualifications of practitioners and
/// organizations
///
/// System: <http://hl7.org/fhir/qualification-status>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
pub enum RestfulInteraction {
    ...
    Update,
    /// update-conditional
    #[serde(rename = "update-conditional")]
    UpdateConditional,
    /// patch
    #[serde(rename = "patch")]
    Patch,
    /// patch-conditional
    #[serde(rename = "patch-conditional")]
    PatchConditional,
    /// delete
    #[serde(rename = "delete")]
    Delete,
    /// delete-conditional-single
    #[serde(rename = "delete-conditional-single")]
    DeleteConditionalSingle,
    /// delete-conditional-multiple
    #[serde(rename = "delete-conditional-multiple")]
    DeleteConditionalMultiple,
    /// delete-history
    #[serde(rename = "delete-history")]
    DeleteHistory,
    /// delete-history-version
    #[serde(rename = "delete-history-version")]
    ...
    Create,
    /// create-conditional
    #[serde(rename = "create-conditional")]
    CreateConditional,
    /// search
    #[serde(rename = "search")]
    Search,
...
/// Example code system illustrating possible codes for identifying the
/// mechanism or algorithm used to make the assessment; e.g. TIMI, PRISM,
...
pub enum RiskAssessmentMethod {
    ...
    Prism,
    /// Cardiff T2D
    #[serde(rename = "cardiff-t2d")]
    CardiffT2D,
}

/// Example code system illustrating possible codes for identifying the
/// condition or other outcome; e.g. death, remission, amputation, infection,
/// etc.
///
...
/// This value set includes simple codes for format defined for
/// CapabilityStatement.format.
///
/// System: <http://hl7.org/fhir/simple-format-codes>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
/// Status of the supply delivery.
///
/// System: <http://hl7.org/fhir/supplydelivery-supplyitemcondition>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum SupplydeliverySupplyitemcondition {
    /// Normal
    #[default]
    #[serde(rename = "normal")]
    Normal,
...
///
/// System: <http://hl7.org/fhir/task-business-status>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum TaskBusinessStatus {
    /// Specimen Collected
    #[default]
    #[serde(rename = "specimen-collected")]
    SpecimenCollected,
    /// IV Prepped
    #[serde(rename = "iv-prepped")]
    IvPrepped,
    /// Specimen In Transit
    #[serde(rename = "specimen-in-transit")]
    SpecimenInTransit,
    /// Waiting For Final Review
    #[serde(rename = "waiting-for-final-review")]
...
pub enum TaskInputoutputParameterType {
    /// Collected Specimen
    #[default]
    #[serde(rename = "collected-specimen")]
    CollectedSpecimen,
    /// Reference Results
    #[serde(rename = "reference-results")]
    ReferenceResults,
    /// Prior Results
    #[serde(rename = "prior-results")]
    PriorResults,
    /// Concomitant Medications
    #[serde(rename = "concomitant-medications")]
...
///
/// System: <http://hl7.org/fhir/task-performer-function-code>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
///
/// System: <http://hl7.org/fhir/task-reason>
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum TaskReason {
    /// Cancellation
    #[default]
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum TestplanAssertionType {
    /// Informative
    #[default]
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
pub enum TestplanScriptLanguage {
    /// Gherkin
    #[default]
