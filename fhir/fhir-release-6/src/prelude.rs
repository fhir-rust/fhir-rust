...
pub use crate::r6::types::String as FhirString;
pub use crate::r6::types::{
...
pub use crate::r6::choice::Primitive;
pub use crate::r6::coded::Coded;
pub use crate::r6::extension_ext::{
    ExtensionExt, HasExtension, HasModifierExtension, ModifierExtensionExt,
};
pub use crate::r6::validate::{Validate, ValidationIssue};

// A few frequently-used code enums.
pub use crate::r6::codes::{
