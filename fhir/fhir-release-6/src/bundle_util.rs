...
//!
//! ```
//! use fhir::r6::resources::{Bundle, Patient};
//!
...
use crate::r6::codes::{BundleType, HttpVerb};
use crate::r6::resources::Resource;
use crate::r6::resources::bundle::{Bundle, BundleEntry, BundleEntryRequest};
use crate::r6::types;
