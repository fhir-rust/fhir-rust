//! Support for the generated R6 resource/datatype builders.
//!
...
//! [`::fhir_core::builder`]; this module re-exports it so R6 code keeps using
//! `fhir::r6::builder::BuilderError`.
//!
//! ```
//! use fhir::r6::resources::Observation;
//! use fhir::r6::coded::Coded;
//! use fhir::r6::codes::ObservationStatus;
//! use fhir::r6::types::CodeableConcept;
//!
