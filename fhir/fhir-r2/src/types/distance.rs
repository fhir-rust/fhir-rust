...
///
/// ```
/// use fhir::r2::types::distance::Distance;
///
...
///
/// ```
/// use fhir::r2::types::distance::DistanceQuantity;
/// use fhir::r2::types;
///
/// let value = DistanceQuantity {
...
///
/// let back: DistanceQuantity = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
