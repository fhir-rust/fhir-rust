...
///
/// ```
/// use fhir::r2::types::human_name::HumanName;
/// use fhir::r2::types;
///
/// let value = HumanName {
...
pub struct HumanName {
    ...
    pub r#use: Option<crate::coded::Coded<crate::r2::codes::NameUse>>,
