...
pub use crate::r2::resources::{
    Bundle, Condition, Encounter, MedicationOrder, Observation, Organization, Patient,
    Practitioner, Procedure, Resource,
};

// The most-used datatypes. `String` is aliased to avoid shadowing std.
pub use crate::r2::types::String as FhirString;
pub use crate::r2::types::{
...
pub use crate::r2::choice::Primitive;
pub use crate::r2::coded::Coded;
pub use crate::r2::extension_ext::{
    ExtensionExt, HasExtension, HasModifierExtension, ModifierExtensionExt,
};
pub use crate::r2::validate::{Validate, ValidationIssue};

// A few frequently-used code enums.
pub use crate::r2::codes::{AdministrativeGender, BundleType, ObservationStatus};
