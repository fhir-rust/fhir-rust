...
//!
//! R2 has no `canonical` or `url` primitive — both arrived in R4 — so this
//! module checks two fewer types than its R4 and R5 counterparts.
//!
//! Provides format checks for the FHIR R2 primitive datatypes (the
//! regular-expression constraints from the specification, implemented without
//! an external regex dependency), and bridges validation results into an R2
//! `OperationOutcome`.
//!
//! The [`Validate`] trait and [`ValidationIssue`] type are shared by every FHIR
//! release and live in [`::fhir_core::validate`]; this module re-exports them so R2
//! code can use `fhir::r2::validate::Validate`. Recursive validation of complex
//! types and resources is generated by `#[derive(Validate)]`.
//!
//! # Examples
//!
//! ```
//! use fhir::r2::types::Id;
//! use fhir::r2::validate::Validate;
//!
...
impl From<ValidationIssue> for crate::r2::resources::operation_outcome::OperationOutcomeIssue {
    fn from(issue: ValidationIssue) -> Self {
        use crate::r2::coded::Coded;
        use crate::r2::codes::{IssueSeverity, IssueType};
        Self {
...
/// `invalid` code, its message in `diagnostics` and its path in `location`.
///
/// DSTU2 predates `OperationOutcome.issue.expression`, which R3 added; the
/// path goes to `location`, its predecessor.
///
/// ```
/// use fhir::r2::resources::Patient;
/// use fhir::r2::resources::operation_outcome::OperationOutcome;
/// use fhir::r2::types::Uri;
/// use fhir::r2::validate::Validate;
///
...
impl From<Vec<ValidationIssue>> for crate::r2::resources::operation_outcome::OperationOutcome {
    fn from(issues: Vec<ValidationIssue>) -> Self {
        use crate::r2::coded::Coded;
        use crate::r2::codes::{IssueSeverity, IssueType};
        use crate::r2::resources::operation_outcome::{OperationOutcome, OperationOutcomeIssue};
...
mod tests {
    ...
    fn required_binding_flags_unknown_code() {
        use crate::r2::coded::Coded;
        use crate::r2::codes::AdministrativeGender;
    ...
    #[test]
    fn invariant_ext_1() {
        use crate::r2::choice::Primitive;
        use crate::r2::types::extension::{Extension, ExtensionValue};
        use crate::r2::types::{Boolean, Uri};

        // R2 types `Extension.url` as a `uri`; R4 and R5 use a `string`.
