...
///
/// ```
/// use fhir::r2::resources::contract::Contract;
/// use fhir::r2::types;
///
/// let value = Contract {
...
pub struct Contract {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub authority: Vec<types::Reference<crate::r2::resources::Organization>>,

    /// Domain in which this Contract applies
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub domain: Vec<types::Reference<crate::r2::resources::Location>>,
...
struct ContractDe {
    ...
    #[serde(default)]
    authority: Vec<types::Reference<crate::r2::resources::Organization>>,
    #[serde(default)]
    domain: Vec<types::Reference<crate::r2::resources::Location>>,
    ...
    #[serde(flatten)]
    binding: crate::r2::choice::Slot<ContractBinding>,
    #[serde(default)]
...
///
/// ```
/// use fhir::r2::resources::contract::ContractActor;
/// use fhir::r2::types;
///
/// let value = ContractActor {
...
///
/// let back: ContractActor = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
...
///
/// ```
/// use fhir::r2::resources::contract::ContractFriendly;
/// use fhir::r2::types;
///
...
struct ContractFriendlyDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    content: crate::r2::choice::Slot<ContractFriendlyContent>,
}
...
///
/// ```
/// use fhir::r2::resources::contract::ContractLegal;
/// use fhir::r2::types;
///
...
struct ContractLegalDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    content: crate::r2::choice::Slot<ContractLegalContent>,
}
...
///
/// ```
/// use fhir::r2::resources::contract::ContractRule;
/// use fhir::r2::types;
///
...
struct ContractRuleDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    content: crate::r2::choice::Slot<ContractRuleContent>,
}
...
///
/// ```
/// use fhir::r2::resources::contract::ContractSigner;
/// use fhir::r2::types;
///
/// let value = ContractSigner {
///     id: Some(types::Id("pat-1".to_string())),
///     ..Default::default()
/// };
/// let json = ::serde_json::to_value(&value).unwrap();
...
pub struct ContractSigner {
    ...
    pub signature: types::String,
    /// Primitive extension sibling for [`signature`](Self::signature) (FHIR `_signature`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_signature")]
    pub signature_ext: Option<types::Element>,
}
...
///
/// ```
/// use fhir::r2::resources::contract::ContractTerm;
/// use fhir::r2::types;
///
...
pub struct ContractTerm {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub actor: Vec<ContractTermActor>,
...
///
/// ```
/// use fhir::r2::resources::contract::ContractTermActor;
/// use fhir::r2::types;
///
/// let value = ContractTermActor {
///     id: Some(types::Id("pat-1".to_string())),
///     ..Default::default()
/// };
/// let json = ::serde_json::to_value(&value).unwrap();
...
/// assert_eq!(json["id"], ::serde_json::json!("pat-1"));
///
/// let back: ContractTermActor = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
#[derive(Debug, Default, Clone, Serialize, Deserialize, PartialEq, Eq, Validate)]
...
///
/// ```
/// use fhir::r2::resources::contract::ContractTermValuedItem;
/// use fhir::r2::types;
///
...
///
/// ```
/// use fhir::r2::resources::contract::ContractValuedItem;
/// use fhir::r2::types;
///
...
struct ContractValuedItemDe {
    ...
    modifier_extension: Vec<types::Extension>,
    #[serde(flatten)]
    entity: crate::r2::choice::Slot<ContractValuedItemEntity>,
    identifier: Option<types::Identifier>,
    effective_time: Option<types::DateTime>,
    #[serde(rename = "_effectiveTime")]
    effective_time_ext: Option<types::Element>,
