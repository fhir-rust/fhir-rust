...
///
/// ```
/// use fhir::r2::resources::communication_request::CommunicationRequest;
/// use fhir::r2::types;
///
/// let value = CommunicationRequest {
///     requested_on: Some(types::DateTime("2019-11-01T09:29:23Z".to_string())),
///     ..Default::default()
/// };
/// let json = ::serde_json::to_value(&value).unwrap();
/// // `requestedOn` is the name this serializes to on the wire.
/// assert_eq!(json["requestedOn"], ::serde_json::json!("2019-11-01T09:29:23Z"));
///
...
pub struct CommunicationRequest {
    ...
    pub status: Option<crate::coded::Coded<crate::r2::codes::CommunicationRequestStatus>>,
    ...
    #[serde(flatten)]
    pub scheduled: Option<CommunicationRequestScheduled>,
    ...
    pub requested_on: Option<types::DateTime>,
    /// Primitive extension sibling for [`requested_on`](Self::requested_on) (FHIR `_requestedOn`):
    /// carries `id` and/or `extension` for the primitive value.
...
///
/// ```
/// use fhir::r2::resources::communication_request::CommunicationRequestPayload;
/// use fhir::r2::types;
///
...
pub enum CommunicationRequestScheduled {
