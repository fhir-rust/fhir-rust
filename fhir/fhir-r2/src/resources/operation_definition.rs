...
///
/// ```
/// use fhir::r2::resources::operation_definition::OperationDefinition;
/// use fhir::r2::types;
///
...
pub struct OperationDefinition {
    ...
    /// operation | query
    pub kind: crate::coded::Coded<crate::r2::codes::OperationKind>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub contact: Vec<OperationDefinitionContact>,
...
///
/// ```
/// use fhir::r2::resources::operation_definition::OperationDefinitionContact;
/// use fhir::r2::types;
///
/// let value = OperationDefinitionContact {
...
///
/// let back: OperationDefinitionContact = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
...
#[serde(rename_all = "camelCase")]
#[fhir_version("r2")]
pub struct OperationDefinitionContact {
...
///
/// ```
/// use fhir::r2::resources::operation_definition::OperationDefinitionParameter;
/// use fhir::r2::types;
///
...
pub struct OperationDefinitionParameter {
    ...
    /// in | out
    pub r#use: crate::coded::Coded<crate::r2::codes::OperationParameterUse>,
...
///
/// ```
/// use fhir::r2::resources::operation_definition::OperationDefinitionParameterBinding;
/// use fhir::r2::types;
///
...
struct OperationDefinitionParameterBindingDe {
    ...
    #[serde(flatten)]
    value_set: crate::r2::choice::Slot<OperationDefinitionParameterBindingValueSet>,
}
