...
///
/// ```
/// use fhir::r2::resources::location::Location;
/// use fhir::r2::types;
///
/// let value = Location {
...
pub struct Location {
    ...
    pub status: Option<crate::coded::Coded<crate::r2::codes::LocationStatus>>,
    ...
    /// instance | kind
    pub mode: Option<crate::coded::Coded<crate::r2::codes::LocationMode>>,
    ...
    pub part_of: Option<types::Reference<crate::r2::resources::Location>>,
}
...
///
/// ```
/// use fhir::r2::resources::location::LocationPosition;
/// use fhir::r2::types;
///
