...
///
/// ```ignore
/// use fhir::r2::resources::document_manifest::DocumentManifest;
///
...
///
/// ```
/// use fhir::r2::resources::document_manifest::DocumentManifestContent;
/// use fhir::r2::types;
///
...
///
/// ```
/// use fhir::r2::resources::document_manifest::DocumentManifestRelated;
/// use fhir::r2::types;
///
