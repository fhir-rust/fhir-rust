//! Parsing and precision-aware comparison for the FHIR R2 date/time
//! primitives.
//!
...
//! R2 newtypes and re-exports the shared types.
//!
//! ```
//! use fhir::r2::types::Date;
//! use fhir::r2::temporal::DatePrecision;
//!
...
use crate::r2::types::{Date, DateTime, Instant, Time};
