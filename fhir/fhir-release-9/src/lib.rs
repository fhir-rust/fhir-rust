...
//!
//! **There is no FHIR R9 specification.** At the time of writing, R6 is in
...
//!    `doc/fhir-specifications/r9/fhir-definitions-json/`.
//! 2. Add `Version::R9` to `src/codegen/version.rs` (module, label, version
//!    string, spec URL, parse tokens).
//! 3. Add `"r9"` to `KNOWN_VERSIONS` in `fhir-derive-macros`.
//! 4. Run `cargo run -- r9`, which writes the model into `fhir-release-9/src`.
